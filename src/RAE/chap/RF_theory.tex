...
\chapter{Teoretické základy radioelektroniky}\label{chap:ra_theory}
  ...
  \section{Úvod do šíření vln pro pozemní rádiové spoje}
    \begin{example}
      ...
      frekvenci \qty{433}{MHz}. Určete délku vln a rádiové pásmo do kterého použitá vlnová délka 
      patří.
      \newline\textbf{řešení:}
      \begin{equation}
        \lambda = c\cdot T = \frac{c}{f} = \frac{\num{300e6}}{\num{433e6}} = \qty{0.49}{\meter}
      \end{equation}
  ...
  \section{Dvojbrany v radioelektronice}
    ...
    \subsection{Vektorové měření impedance a přizpůsobení}
      ...
      \subsubsection{Impedanční přizpůsobení pomocí obvodů se soustředěnými parametry}
        ...
        vedení o reálné vlnové impedanci \(Z_0 = \qty{50}{\ohm}\) (půjde tedy současně i o 
        ...
        \(Z_L\) bude při daném kmitočtu vykazovat vstupní impedanci rovnou \(Z_0 = \qty{50}{\ohm}\).
