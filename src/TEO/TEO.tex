...
%---------------------------------------------------------------------------------------------------
\ifthenelse{ \equal{\DebugMode}{true} }{ % Debug mode ON
  \input{../src/TEO/chap/es1ch05.tex}
}{ % DEBUG was off
\LuaPartBckgrnd{titleBG_fractal1.png}
\LuaPartTitle{ES I}{Elektronické součástky}{ESI}
\parttoc
%========== Kapitola: Pasivni součástky ============================================================
  \input{../src/TEO/chap/es1ch01.tex}
%========== Kapitola: Bipolární transzistory =======================================================
  \input{../src/TEO/chap/es1ch05.tex}
%========== Kapitola: Unipolární transzistory ======================================================
  \input{../src/TEO/chap/es1ch06.tex}
%========== Kapitola: Optočleny ====================================================================
  \input{../src/TEO/chap/es1ch09.tex}
%=============== Seznam literatury =================================================================
\printbibliography[title={Seznam literatury}, heading=bibliography]
}  % DEBUG was off
%---------------------------------------------------------------------------------------------------
...
%========== Kapitola: Spojité matematické modely jednotlivých polí =================================
  % \input{../src/TEO/chap/spojity_model_elmag_p.tex} % přesunuto do FYZ3 
%========== Kapitola: Základní zákony elektromagnetismu ============================================
  % \input{../src/TEO/chap/magn1ch01.tex}             % přesunuto do FYZ3
%========== Kapitola: Topologické vlastnosti elektromagnetického pole ==============================
  % \input{../src/TEO/chap/magn1ch02.tex}             % přesunuto do FYZ3
%========== Kapitola: Elektromagnetického pole ====================================================
  % \input{../src/TEO/chap/magn1ch03.tex}             % přesunuto do FYZ3
