...
%     \end{mdframed} 
  ...
  \section{Analýza elektrických obvodů}
    ...
    \subsection{Modelování, analýza, simulace}
      ...
      reprezentují způsob propojení součástek \cite[s.~16]{Biolek2004}.
      ...
      matematickými vzorci \cite[s.~17]{Biolek2004}.
      ...
      \subsubsection{Pravidla pro sestavování rovnic}
        ...
        \begin{table}[ht!]
          ...
          \begin{tabular}{c|c|c|c|c|@{}l@{}|c|}
             ...
             \raisebox{.5pt}{\textcircled{\raisebox{-.9pt} {1}}} % uzel 1:  
                & $I$   & \multirow{2}{*}{=} & $G_1+G_2$ & $-G_2$         &   & $U_2$    \\
             \cline{2-2} \cline{4-5} \cline{7-7}
             \raisebox{.5pt}{\textcircled{\raisebox{-.9pt} {2}}} % uzel 2:  
                &       &                    & $-G_2$    & $G_2+G_3+G_4$  &   & $U_2$    \\
             \cline{2-2} \cline{4-5} \cline{7-7}
          \end{tabular}
          \caption*{ }
        ...
        %---------------------------------------------------------------
        \input{../src/TEO/exam/exam020.tex}
        %---------------------------------------------------------------
