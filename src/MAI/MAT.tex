...
\begin{center}
  \vspace{1cm}
  \Huge \uppercase{\textbf{Matematická analýza I}} \\
  \vspace{2cm}
  % https://mymodernmet.com/colouring-book-rafael-araujo-golden-ratio/
  \includegraphics[width=0.9\linewidth]{MAI.jpg}
\end{center}
}
...
%  \input{../src/MAI/chap/chap_Int_rfce_1var.tex}
%  \input{../src/MAI/chap/Theory_of_Derivatives.tex}
%  \input{../src/MAI/chap/Differential_Calculus_applications.tex}
...
\begin{center}
  ...
  \vspace{2cm}
  % https://mymodernmet.com/colouring-book-rafael-araujo-golden-ratio/
  \includegraphics[width=0.9\linewidth]{MAII.jpg}
\end{center}
}
