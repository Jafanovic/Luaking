...
\chapter{Poznáváme funkci z její derivace - neurčitý integrál}\label{mai:IchapVII}
  ...
  \section{Motivace}
    ...
    \subsection{Definice primitivní funkce}\label{mai:IchapVIIsecI}    
      ...
      \begin{mathdef}{Neručitý integrál}{def004} 
      ...
      \begin{mathlemma}{Vztah mezi spojitostí funkce \(f(x)\) a primitivní funkcí k
        \(F(x)\)}{lemma011}         
        Je-li funkce \(f(x)\) \emph{spojitá} na intervalu, pak k ní existuje primitivní funkce na
        tomto intervalu.
      \end{mathlemma}
      Větu nebudeme dokazovat, protože k tomu nemáme potřebné nástroje.
  ...
  \section{Metody určení primitivní funkce}\label{mai:IchapVIIsecIII}
    ...
    \subsection{Integrace po částech - per partes}\label{mai:IchapVIIsecIIIssecII} V kapitole
      ...
      dovedeme snadno integrovat. 
      
      Metoda integrace \emph{per partes} neboli využívá vzorce pro derivaci součinu funkcí.
