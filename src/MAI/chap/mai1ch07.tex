...
\chapter{Poznáváme funkci z její derivace - neurčitý integrál}\label{mai:IchapVII}
  ...
  \section{Základní integrály}\label{mai:IchapVIIsecII} 
    ...
    \begin{enumerate}
      ...
      \item Derivace funkce \(y=\dfrac{1}{2a}\ln\abs{\dfrac{x-a}{x+a}}\), \(a\neq0\), \(x\neq a\),
            \(x\neq -a\) je
            \begin{equation*}
              y'=\frac{1}{2a}\cdot\frac{x+a}{x-a}\cdot\frac{x+a-(x-a)}{(x+a)^2} = \frac{1}{x^2-a^2}.
            \end{equation*}
            Tedy pro \(a\neq0\) je
            \begin{equation*}
      ...
      \item Pro všechna reálná \(x\) platí
            ...
            \begin{flalign*}
              ...
              & \int{a^x}\dd{x} \frac{a^x}{\ln{a}} + c \, a>0, a\neq1, x\in(-\infty,+\infty)    & 
            \end{flalign*}
            ...
            \begin{equation*}
              \left.
                \begin{array}{r}
                  ...
                  \int\dfrac{1}{\sqrt{1-x^2}}\dd{x} = -\arccos x + c
                \end{array}
              \right\}x\in(-1,1).
            \end{equation*}
    \end{enumerate}
    ...
    \subsection{Elementárnost primitivních funkcí}   
  ...
  \twocolumn[\section{Metody určení primitivní funkce}]
    ...
    \subsection{Integrování součtu, úprava integrandu}  
      %-------------------------------------
    ...
    \subsection{Substituční metoda typu \(\varphi(x) = t\)}
      ...
      taková, že výpočet konkrétních příkladů je schématicky veden od rov. \ref{mai:eq177} ke
      vzorci rov. \ref{mai:eq176}.
