...
\minitoc
  ...
  \section{Náhodné veličiny}\label{mai:IchapIIIsecII}
    ...
    \adjustbox{minipage=[c][38pt][c]{406pt}}{%
    ...
    \end{align}
    hodnota
    \adjustbox{minipage=[c][28pt][c]{406pt}}{%
    ...
    \adjustbox{minipage=[c][86pt][c]{406pt}}{%
    ...
    \begin{figure}[ht!] %\ref{mai:fig045}
      \centering
      \includegraphics[width=0.5\linewidth]{mai_fig045.png}
    ...
    \subsection{Kolik rychlostí má molekula plynu - spojité rozdělení}
      ...
      \adjustbox{minipage=[c][68pt][c]{406pt}}{%
      ...
      \end{equation*}
      \adjustbox{minipage=[c][48pt][c]{406pt}}{%
  ...
  \section{Náhoda a zpracování měření}
    \subsection{Součet a součin náhodných veličin}
      ...
      \adjustbox{minipage=[c][24pt][c]{406pt}}{%
      ...
      \end{align*}
      Pak
      \adjustbox{minipage=[c][34pt][c]{406pt}}{%
        \begin{equation*}
    ...
    \subsection{Který výsledek je ten pravý?}
      ...
      hodnota. Pro tuto chvíli však předpokládejme,
