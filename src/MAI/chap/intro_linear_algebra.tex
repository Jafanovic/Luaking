...
%--------------------------------------------------------------------------------------------------
  \section{Počítání s čísly}\label{mai:IchapIIsecII}
    ...
    \subsection{Komplexní čísla}
      ...
      \input{../src/MAI/exam/exam078.tex}
      %---------------------------------------------------------------
    ...
    \begin{figure}[ht!]  %\ref{mai:fig053}
      \centering
      \includegraphics[width=0.6\linewidth]{mai_fig053.png}
    ...
    \adjustbox{minipage=[c]{\textwidth}}{%
      \begin{equation*}
        \abs{z} = \sqrt{x^2 + y^2}, \qquad \tan\varphi = \dfrac{x}{y},
      \end{equation*}
      \begin{equation*}
        x = \abs{z}\cos\varphi, \qquad y = \abs{z}\sin\varphi,  \qquad
    ...
    \input{../src/MAI/exam/exam079.tex}
    %---------------------------------------------------------------
    
    \adjustbox{minipage=[c]{\textwidth}}{%
      Vidíme, že
      \begin{equation}\label{mai:eq74}
        \abs{z_1z_2} = \abs{z_1}\cdot\abs{z_2}, \qquad \arg{(z_1z_2)} = \arg{z_1} + \arg{z_2} 
      \end{equation}
    }
    ...
    \input{../src/MAI/exam/exam080.tex}
    %---------------------------------------------------------------

    %--Cvičení------------------------------------------------------
    \input{../src/MAI/exam/exam081.tex}
    %---------------------------------------------------------------
%--------------------------------------------------------------------------------------------------
  \section{Počítání s maticemi}\label{mai:IchapIIsecIII}
    ...
    \subsection{Základní operace s maticemi a hodnost matic}\label{mai:IchapIIsecIIIsubI}
      ...
      \adjustbox{minipage=[c]{\textwidth}}{%
        \begin{definition}\label{def_matice}
          ...
          \{1,2,\ldots,m\}\times \{1,2,\ldots,m\}\) přiřadíme prvek \(a_{i,j}\in\mathbb{R}\) 
      ...
      První operací, která nás napadne je \textbf{sčítání matic}, což je operace kterou vznikne nvá 
    ...
    \subsection{Hodnost matic}\label{mai:IchapIIsecIIIsubII}
      ...
      \input{../src/MAI/exam/exam082.tex}
      %---------------------------------------------------------------
      ...
      \ref{mai:IchapIIsecI}. Z toho, co jsme si nyní řekli o lineárně závislých řádcích matice, 
      ...
      \(mn\) (všimněte si souvislosti s pojmem dimenze). Soubor matic (\(\matr{E}_{ij}\)) tvoří 
      ...
      \input{../src/MAI/exam/exam083.tex}
      %---------------------------------------------------------------
    ...
    \subsection{Násobení matic}\label{mai:IchapIIsecIIIsubIII}
      ...
      \adjustbox{minipage=[c]{\textwidth}}{%
        \begin{definition} 
          \textbf{Součinem matice} \(A \in \mathbb{R}_{mn}\) a matice \(B \in \mathbb{R}_{np}\), v 
          uvedeném pořadí, je matice \(C \in \mathbb{R}_{mp}\) pro kterou platí:
          \begin{align*}
                 C &= AB; \quad C = (cij); \\
                 \shortintertext{kde}
