...
\begin{mdframed}[style=mdexam]
  \begin{example}\label{mai:exam047}
    \textbf{Algebraická struktura a kupecké počty}\newline
      ...
      Neutrálním prvkem \(0_{\mathbb{R}}\) je \uv{obyčejná} nula, opačným prvkem k číslu \(a\) je
      ...
      (\uv{obyčejná} jednička) vyhovuje prvnímu požadavku ve vztazích \ref{mai:eq050}. Potíž je s
