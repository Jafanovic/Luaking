...
\begin{mdframed}[style=mdexam]
  \begin{example}\label{mai:exam068}
    ...
    \begin{itemize}
      \item \ce{Cs^137} \(\longrightarrow\) \ce{Ba^137} + elektron + neutrino, asi \qty{8}{\percent} 
            všech rozpadů
      \item \ce{Cs^137} \(\longrightarrow\) \ce{Ba^137}* + elektron + neutrino, asi \qty{92}{\percent} 
            všech rozpadů
    \end{itemize}
    \begin{equation*}
