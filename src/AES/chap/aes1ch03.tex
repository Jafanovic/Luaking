  ...
  \section{Parametry OZ}\label{aesIchIIIsecII}
    ...
    \subsection{Lineární model a parametry}\label{aesIchIIIsecIIssecI}
      ...
      \subsubsection{Zesílení. Diferenční vstupní odpor a výstupní odpor}\label{aesIchIIIsecIIssecV}
        ...
        \begin{subequations}\label{aes:eq036}
          ...
          \end{align}
        \end{subequations}
        \footnotetext{Přesně \(f_T = f_0\sqrt{A_0^2-1} = f_0A_0\sqrt{1 - \dfrac{1}{A_0^2}}\).}
    ...
    \subsection{Nelineární parametry}\label{aesIchIIIsecIIssecVII}
      ...
      \begin{figure}[ht!]  %\ref{aes:fig058}
        \centering
        \subcaptionbox{\(f\ll f_P,\, U>U_0\)          \label{aes:fig058a}}{\luafigure[0.45]{aes_fig058a.jpg}}
        \hspace{1em}                                                       
        \subcaptionbox{\(f\ll f_P,\, R_L\ll U_0/I_0\) \label{aes:fig058b}}{\luafigure[0.45]{aes_fig058b.jpg}}        
        \newline                                                    
        \subcaptionbox{\(f>f_P\)                      \label{aes:fig058c}}{\luafigure[0.45]{aes_fig058c.jpg}}    
        \hspace{1em}                                                       
        \subcaptionbox{\(f\gg f_P\)                   \label{aes:fig058d}}{\luafigure[0.45]{aes_fig058d.jpg}}                                   
    ...
    \subsection{Bipolární vstupní stupeň}\label{aesIchIIIsecIIIssecI}
      ...
      \begin{figure}[ht!]  %\ref{aes:fig060}
        ...
        \subcaptionbox{Zvláštností bipolárního diferenčního stupně je možnost současného vynulování
                  ofsetu a teplotního driftu nastavením kolektorových
                  rezistorů \label{aes:fig060b}}
