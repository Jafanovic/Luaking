...
\chapter{Modelování a simulace pomocí SPICE}
  ...
  \section{Základní analýzy}
    \subsection{Stejnosměrná analýza}
      ...
      \ref{aes:fig_fig020a}. První krok spočívá v odstranění setrvačných prvků z obvodu, protože ty
      ...
      \begin{figure}[ht!]
        \centering  
        \subcaptionbox{\label{aes:fig_fig020a}}{\luafigure[0.9]{aes_fig020a.png}}          \newline
        \subcaptionbox{\label{aes:fig_fig020b}}{\luafigure[0.5]{aes_fig020b.png}}               
      ...
      \ref{aes:fig_fig021a} je znázorněna závislost \(U_2=f(U_1)\). Jedná se vlastně o zesilovač v
      ...
      \begin{figure}[ht!]
        \centering  
        \subcaptionbox{\label{aes:fig_fig021a}}{\luafigure[0.40]{aes_fig021a.png}}    \hspace{1em}
        \subcaptionbox{\label{aes:fig_fig021b}}{\luafigure[0.45]{aes_fig021b.png}}               
      ...
      \ref{aes:fig_fig021b}. Metoda hledá kořen algebraické rovnice, tj. \emph{průsečík nějaké
    ...
    \subsection{Analýza v časové oblasti}
      ...
      \subsection{Stabilita integrační metody}
        ...
        \(\Delta t\lambda\) ležící v levé polorovině, viz obr. \ref{aes:fig_fig018a}. Tuto vlastnost
        ...
        \begin{figure}[ht!]
          \centering  
            \subcaptionbox{\label{aes:fig_fig018a}}{\luafigure[0.45]{aes_fig018a.png}}  \hspace{1em}            
            \subcaptionbox{\label{aes:fig_fig018b}}{\luafigure[0.45]{aes_fig018b.png}}  \newline            
            \subcaptionbox{\label{aes:fig_fig018c}}{\luafigure[0.45]{aes_fig018c.png}}  
          \caption{Oblast absolutní stability a) lichoběžníková metoda; b), c) Gearova metoda}
          \label{aes:fig_fig018}
        \end{figure}

        Jedna z nejrozšířenějších metod, která je využita i v \texttt{PSpice}, je tzv.
        \textbf{Gearova metoda}. Na obr. \ref{aes:fig_fig018b} a \ref{aes:fig_fig018c} jsou
