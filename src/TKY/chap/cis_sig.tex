...
\minitoc
  ...
  \section{Základní operace s posloupnosti}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{c}
        \hspace{0.1cm}
        \subfloat[ ]   {\label{tky:fig_007a}
          \includegraphics[width=0.4\linewidth]{tky_fig007a.pdf}}  \\
        \subfloat[ ]   {\label{tky:fig_007b}
          \includegraphics[width=0.4\linewidth]{tky_fig007b.pdf}}  \\
        \subfloat[ ]   {\label{tky:fig_007c}
          \includegraphics[width=0.4\linewidth]{tky_fig007c.pdf}}
      \end{tabular}
