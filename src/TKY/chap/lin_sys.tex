...
\minitoc
  \section{Vlastnosti a popis lineárních systému}
    ...
    \begin{wrapfigure}[7]{r}{5cm}
      \centering
      \includegraphics[width=0.9\linewidth]{tky_fig005.pdf}
      ...
      \begin{figure}[ht!]
        ...
        \begin{tabular}{cc}
          \subfloat[ ]{\label{tky:fig_006a}
            \includegraphics[width=0.4\linewidth]{tky_fig006a.pdf}}              &
          \subfloat[ ]{\label{tky:fig_006b}
            \includegraphics[width=0.4\linewidth]{tky_fig006b.pdf}}              \\
        \end{tabular}
        \caption{Posloupnost jednotkového skoku \(1[n]\) a signálu \(x[n]\)}
        \label{tky:fig_006}
      \end{figure}
      %---------------------------------------------
%      \input{../src/TKY/img/posloupnost_1n_xn.tex}
