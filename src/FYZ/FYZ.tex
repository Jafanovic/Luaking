...
%  \input{../src/FYZ/chap/history_AFYZ.tex}
}
{
% DEBUG was off
...
\begin{center}
  \vspace{1cm}
  \Huge \uppercase{\textbf{Fyzika II}} \\
  \vspace{2cm}
%  \includegraphics[width=0.8\linewidth]{Norbert_Wiener.jpg}
\end{center}
}
...
\begin{center}
  \vspace{1cm}
  \Huge \uppercase{\textbf{Fyzika III}} \\
  \huge \uppercase{\textbf{Teorie elektromagnetického pole}} \\
  \vspace{2cm}
%  \includegraphics[width=0.8\linewidth]{Norbert_Wiener.jpg}
\end{center}
}
