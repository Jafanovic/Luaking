...
\chapter{Ilustrace termodynamiky}\label{fyz:IchapXLV}
  \section{Vnitřní energie}\label{fyz:IchapXLVsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0463}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0463.pdf}
    ...
    Nyní vyjádříme vyšrafovanou plochu geometricky. Cyklus znázorněný na obr. \ref{fyz:fig0463} se
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0464}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0464.pdf}
  ...
  \section{Clasiova-Clapeyronova rovnice}\label{fyz:IchapXLVsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0465}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0465.pdf}
      \caption{ 
              (\cite[s.~707]{Feynman01})}
      \label{fyz:fig0465}
    \end{figure}

    \begin{figure}[ht!] %\ref{fyz:fig0466}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0466.pdf}
      \caption{ 
              (\cite[s.~707]{Feynman01})}
      \label{fyz:fig0466}
    \end{figure}
  \section{Příklady a cvičení}\label{fyz:IchapXLVsecIV}
    \subsection{Výhřevnost paliva}\label{fyz:IchapXLVsecIVssecI}
      Výhřevnost \(H\) [\unit{\joule\per\kg}] je vlastnost paliva, která udává, kolik energie se
      uvolní úplným spálením jedné jednotky (obvykle \qty{1}{\kg}). Proti spalnému teplu není v
