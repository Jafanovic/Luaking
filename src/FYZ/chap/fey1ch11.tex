...
\chapter{Vektory}\label{fyz:IchapXI}
  ...
  \section{Translace}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig113}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig113.pdf}
  ...
  \section{Rotace}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig114}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig114.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig115}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig115.pdf}
  ...
  \section{Vektorová algebra}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig116}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig116.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig117}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig117.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig118}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig118.pdf}
    ...
    \subsection{Inerciální souřadnicová soustava}
      ...
      \luagraphic[1]{fyz_fig926.png}{Experiment Harolda Waaga ukazuje jednoduchou realizaci lokální
      inerciální soustavy. (\cite[s.~8]{Kulhanek2020})}{fyz:fig926}
  ...
  \twocolumn[\section{Newtonovy zákony ve vektorovém tvaru}]
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig119}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig119.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig120}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig120.pdf}
  ...
  \section{Skalární součin}
    ...
    \luagraphic[1]{fyz_fig927.pdf}{Geometrický způsob výpočtu \(\vec{a}\cdot\vec{b}\)
    (\cite[s.~9]{Kulhanek2020})}{fyz:fig927}
    ...
    vektoru \(\vec{a}\); pak jedinou složkou \(\vec{a}\) je \(a_x\) a tato složka představuje i
  ...
  \section{Vektorový součin} 
    ...
    \luagraphic[0.8]{fyz_fig930.pdf}{Vektorový součin \(\vec{a}\times\vec{b}\)}{fyz:fig930}
    ...
    \luagraphic[0.7]{fyz_fig928.pdf}{Mnemotechnická pomůcka pro určení indexů složek vektorového
    součinu \(\vec{a}\times\vec{b}\) (\cite[s.~11]{Kulhanek2020})}{fyz:fig928}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig929}
      \centering
      \subcaptionbox{\label{fyz:fig929a}}{\luafigure[0.45]{fyz_fig929a.pdf}}
      \subcaptionbox{\label{fyz:fig929b}}{\luafigure[0.45]{fyz_fig929b.pdf}}
    ...
    součin potom podle definice (\ref{fyz:eq752}) vyjde
