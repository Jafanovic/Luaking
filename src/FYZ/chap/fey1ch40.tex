...
\chapter{Principy statistické mechaniky}\label{fyz:IchapXL}
  ...
  \section{Exponenciální atmosféra}\label{fyz:IchapXLsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0344}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0344.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0345}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0345.pdf}
  ...
  \section{Příklady a cvičení}\label{fyz:IchapXLsecVII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0346}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0346.pdf}
      \caption{Graf závislosti potenciální energie dvou molekul na jejich vzdálenosti
               (\cite[s.~543]{Feynman01})}
      \label{fyz:fig0346}
    \end{figure}

    \begin{figure}[ht!] %\ref{fyz:fig0347}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0347.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0348}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0348.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0349}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0349.pdf}
