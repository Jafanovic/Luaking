...
\chapter{Analogie elektrostatiky}\label{fyz:IIchapXII}  
  ...
  \twocolumn[\section{Proudění tepla. Bodový zdroj v blízkosti nekonečného rovinného 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0724}
      \centering
        \subcaptionbox{\label{fyz:fig0724a}}{\luafigure[0.45]{fyz_fig0724a.pdf}}                                                  
        \subcaptionbox{\label{fyz:fig0724b}}{\luafigure[0.45]{fyz_fig0724b.pdf}}                    
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0725}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0725.pdf}
  ...
  \section{Napnutá membrána}\label{fyz:IIchapXIIsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0726}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0726.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0727}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0727.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0728}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0728.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0729}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0729.pdf}
  ...
  prostředí}\label{fyz:IIchapXIIsecIV}] 
    ...
    víme z elektrostatiky, můžeme využít i k řešení úloh o difúzi neutronů. Řešme tedy nějakou
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0730a}}{\luafigure[0.6]{fyz_fig0730a.pdf}}               \\
      \subcaptionbox{\label{fyz:fig0730b}}{\luafigure[0.6]{fyz_fig0730b.pdf}}
      \label{fyz:fig0730}
  ...
  \twocolumn[\section{Bezvírové proudění kapaliny. Obtékání koule}\label{fyz:IIchapXIIsecV}]
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0731}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0731.pdf}
  ...
  \section{Osvětlení. Homogenní osvětlení roviny}\label{fyz:IIchapXIIsecVI} 
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0732}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0732.pdf}
  ...
  \section{\uv{Fundamentální jednotka} přírody}\label{fyz:IIchapXIIsecVII}
    ...
    Ukazují se být správnými až do vzdáleností asi \qty{e-16}{\m}, ale pak začínají vypadat jako
