...
\chapter{Dvojrozměrná rotace}\label{fyz:IchapXVIII}
  ...
  \section{Rotace tuhého tělese}\label{fyz:IchapXVIIIsecII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0398}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0398.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0399}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0399.pdf}
  ...
  \section{Moment hybnosti}\label{fyz:IchapXVIIIsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0400}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0400.pdf}
  ...
  \section{Zachování momentu hybnosti}\label{fyz:IchapXVIIIsecIV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0401}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0401.pdf}
