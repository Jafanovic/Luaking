...
\chapter{Newtonovy zákony dynamiky}\label{fyz:IchapIX}
  ...
  \section{Směr a velikost rychlosti}\label{fyz:IchapIXsecII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0056}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0056.pdf}
  ...
  \section{Složky rychlosti, zrychlení a síly}\label{fyz:IchapIXsecIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0057}
      \centering
      \includegraphics[width=0.5\linewidth]{fyz_fig0057.pdf}
  ...
  \section{Co je to síla?}\label{fyz:IchapIXsecIV}
    ...
    \luagraphic[0.8]{fyz_fig0101.pdf}{Závaží na pružině (\cite[s.~127]{Feynman01})}{fyz:fig0101}
  ...
  \section{Numerické řešení rovnic}\label{fyz:IchapIXsecVI}
    ...
    vrátit a výpočty provádět s \(\varepsilon = \qty{0.010}{\s}\). Ptáme se, jaké je 
    \(x(\num{0.1})\), vycházíme-li z počáteční hodnoty \(x(0) = \num{1.00}\). Bude rovno původní 
    poloze \(x(0)\) zvětšené o rychlost (která je nulová) násobenou \qty{0.10}{\s}. Proto je 
    \(x(0,1)\) stále rovno \num{1.00}, neboť pohyb ještě nezačal. Nová rychlost v čase 
    \qty{0.10}{\s} bude rovna původní rychlosti \(v(0) = 0\) zvětšené o součin \(\varepsilon\) a 
    zrychlení. Zrychlení je \(-x(0) = \num{-1.00}\). Je tedy
    \begin{align*}
      v(\num{0.1}) &= \num{0.00} - \num{0.10}\cdot\num{1.00} = -\num{0.10}. \\ 
      \shortintertext{V čase \qty{0.20}{\s} máme}
    ...
    postupu, získali bychom jen přibližný obraz o pohybu, neboť \(\varepsilon= \qty{0.100}{\s}\) je 
    ...
    při původním intervalu \(\varepsilon= \qty{0.10}{\s}\). Toho lze dosáhnout rafinovaným zlepšením 
    metody analýzy.
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0102}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0102.pdf}
    ...
    \qty{1.5}{\s}\) dojde k opačnému pohybu: poloha \(x\) bude záporná a zrychlení tedy kladné. 
    ...
    \begin{table}[ht!]      %\ref{fyz:tab006}
      ...
      \begin{tabular}{|>{\centering\arraybackslash}p{3em}|>{\centering\arraybackslash}p{4em}
        ...
        \hline 
      \end{tabular}} 
      \caption{Řešení rovnice \(\der{v_x}{t} = -x\), interval \(\varepsilon =
        \qty{0.1}{\s}\)  (\cite[s.~130]{Feynman01})}
      \label{fyz:tab006}
     \end{table}
  ...
  \section{Pohyb planet}\label{fyz:IchapIXsecVII}
    ...
    \luagraphic[0.8]{fyz_fig0103.pdf}{Gravitační síla působící na planetu 
    (\cite[s.~131]{Feynman01})}{fyz:fig0103}
    ...
    Trajektorie protíná osu \(x\) v okamžiku \(t = \qty{2.101}{\s}\); perioda oběhu je 
    \qty{4.20}{\s}; \(v_x = 0\) v okamžiku \(t = \qty{2.086}{\s}\). Trajektorie vytíná na ose \(x\) 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0104}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0104.pdf}
      \caption{Vypočítaný pohyb planety kolem Slunce (\cite[s.~134]{Feynman01})}
      \label{fyz:fig0104}
    \end{figure}
    
    Kdyby počítači trvalo sčítání \qty{1}{\us}, násobení asi \qty{10}{\us}. Bude-li v 
    jednom výpočetním cyklu nějaké úlohy například \num{30} násobení, pak takový cyklus potrvá 
    \qty{300}{\us}. Pak můžeme za jednu sekundu provést \num{3000} výpočetních cyklů. Kdybychom 
