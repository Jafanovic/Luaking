...
\chapter{Proudění \uv{suché vody}}\label{fyz:IIchapXL}
  ...
  \section{Hydrostatika}\label{fyz:IIchapXLsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0544}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0544.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0545}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0545.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0546}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0546.pdf}
  ...
  \section{Pohybové rovnice}\label{fyz:IIchapXLsecII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0547}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0547.pdf}
  ...
  \section{Ustálené proudění - Bernoulliova věta}\label{fyz:IIchapXLsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0547}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0548.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0549a}}{\luafigure[0.9]{fyz_fig0549a.pdf}}               \\
      \subcaptionbox{\label{fyz:fig0549b}}{\luafigure[0.9]{fyz_fig0549b.pdf}}              
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0550}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0550.pdf}
    ...
    dokázat, že výtokový koeficient je přesně \qty{50}{\percent}. Zde jen naznačíme, jak důkaz 
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0551}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0551.pdf}
    ...
    výtokový koeficient je \sfrac{1}{2}. Tento způsob výpočtu nemůžeme použít v případě výtokového 
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0552}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0552.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0553}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0553.pdf}
  ...
  \section{Vířivé proudění}\label{fyz:IIchapXLsecIV}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0554a}}{\luafigure[0.35]{fyz_fig0554a.pdf}}
      \subcaptionbox{\label{fyz:fig0554b}}{\luafigure[0.15]{fyz_fig0554b.pdf}}
      \subcaptionbox{\label{fyz:fig0554c}}{\luafigure[0.35]{fyz_fig0554c.pdf}}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0555}
      \centering
      \includegraphics[width=0.3\linewidth]{fyz_fig0555.pdf}
  ...
  \section{Vírové čáry}\label{fyz:IIchapXLsecV}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0556a}}{\luafigure[0.45]{fyz_fig0556a.pdf}}
      \subcaptionbox{\label{fyz:fig0556b}}{\luafigure[0.45]{fyz_fig0556b.pdf}}              
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0557}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0557.pdf}
    ...
    Je to „buben“ s průměrem a délkou asi \qty{60}{cm}, který získáme, napneme-li silnou gumovou 
    fólii na otevřený konec válcové „krabice“. Buben je překlopen na stranu a jeho dno je pevné s 
    výjimkou otvoru, který má průměr asi \qty{8}{cm}. Udeříme-li prudce na gumovou membránu, vyrazí 
    z otvoru vírový prstenec.
    
    Ačkoliv je neviditelný, můžeme se o jeho existenci přesvědčit podle toho, že sfoukne plamen 
    svíčky ve vzdálenosti \num{3}-\qty{6}{m}. Ze zpoždění tohoto jevu poznáme, že „něco“ se šíří 
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0558a}}{\luafigure[0.45]{fyz_fig0558a.pdf}}
      \subcaptionbox{\label{fyz:fig0558b}}{\luafigure[0.45]{fyz_fig0558b.pdf}}              
