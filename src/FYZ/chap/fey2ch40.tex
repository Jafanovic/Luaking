...
\chapter{Proudění \uv{suché vody}}\label{fyz:IIchapXL}
  ...
  \section{Hydrostatika}\label{fyz:IIchapXLsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig544}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz:fig545}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz:fig546}
      \centering
  ...
  \section{Pohybové rovnice}\label{fyz:IIchapXLsecII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig547}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig547.pdf}
  ...
  \section{Ustálené proudění - Bernoulliova věta}\label{fyz:IIchapXLsecIII}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig549a}}{\luafigure[0.9]{fyz_fig549a.pdf}}               \\
      \subcaptionbox{\label{fyz:fig549b}}{\luafigure[0.9]{fyz_fig549b.pdf}}              
    ...
    \begin{figure}[ht!] %\ref{fyz:fig550}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz:fig551}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz:fig552}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz:fig553}
      \centering
  ...
  \section{Vířivé proudění}\label{fyz:IIchapXLsecIV}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig554a}}{\luafigure[0.35]{fyz_fig554a.pdf}}
      \subcaptionbox{\label{fyz:fig554b}}{\luafigure[0.15]{fyz_fig554b.pdf}}
      \subcaptionbox{\label{fyz:fig554c}}{\luafigure[0.35]{fyz_fig554c.pdf}}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig555}
      \centering
  ...
  \section{Vírové čáry}\label{fyz:IIchapXLsecV}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig556a}}{\luafigure[0.45]{fyz_fig556a.pdf}}
      \subcaptionbox{\label{fyz:fig556b}}{\luafigure[0.45]{fyz_fig556b.pdf}}              
    ...
    \begin{figure}[ht!] %\ref{fyz:fig557}
      \centering
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig558a}}{\luafigure[0.45]{fyz_fig558a.pdf}}
      \subcaptionbox{\label{fyz:fig558b}}{\luafigure[0.45]{fyz_fig558b.pdf}}              
