...
\chapter{Difrakce}\label{fyz:IchapXXX}
  \section{Výsledná amplituda n stejných oscilátorů}\label{fyz:IchapXXXsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0249}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0249.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0250}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0250.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0251}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0251.pdf}
  ...
  \section{Difrakční mřížka}\label{fyz:IchapXXXsecII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0252}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0252.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0253}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0253.pdf}
  ...
  \section{Rozlišovací schopnost mřížky}\label{fyz:IchapXXXsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0254}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0254.pdf}
  ...
  \section{Difrakce na neprůzračné cloně}\label{fyz:IchapXXXsecVI}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0255}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0255.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0256}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0256.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0257}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0257.pdf}
    ...
    bodě přesně proti hraně. Intenzita je zde rovna \sfrac{1}{4} intenzity dopadajícího světla. V 
    ...
    poloviční amplitudu, což odpovídá \sfrac{1}{4} intenzity záření.
  ...
  \section{Pole nábojů kmitajících v rovině}\label{fyz:IchapXXXsecVII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0258}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0258.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0259}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0259.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0260}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0260.pdf}
