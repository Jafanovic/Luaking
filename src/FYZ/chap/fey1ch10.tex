...
\chapter{Zachování hybnosti}\label{chap:fey_hybnost}
  ...
  \section{Třetí Newtonův zákon}
    ...
    například víme, že zrychlení padajícího tělesa je \qty{10}{\m\per\square\s} a tento poznatek nám 
  ...
  \section{Relativistická hybnost}
    ...
    \qty{300000}{\km\per\s}. V průběhu takovéhoto kraťoučkého intervalu se hybnost částic 
