...
\chapter{Integrální počet vektorových polí}\label{fyz:IIchapIII}
  ...
  \section{Tok povrchem krychle. Gaussova věta}\hypertarget{fyz:IIchapIIIsecIII}
    ...
    \ref{fyz:fig0215}. Předpokládejme, že souřadnice jednoho z vrcholu krychle je totožný 
    ...
    každou ze šesti stěn. Nejdříve uvažujeme stěnu na obrázku \ref{fyz:fig0215} označenou 
  ...
  \section{Cirkulace vektorového pole}\label{fyz:IIchapIIIsecIV}
    ...
    vidět na obr. \ref{fyz:fig0038}. Zvolíme-li naše křivky dostatečně malé, můžeme, bez 
  ...
  \section{Pole s nulovou rotací a divergencí}\label{fyz:IIchapIIIsecVI}
    ...
    funkcí polohy. Stejnou logiku jsme použili v kapitole \ref{fyz:IchapXIII}, kde jsme 
