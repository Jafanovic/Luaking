...
\minitoc
  ...
  \section{Tok vektorového pole}\label{fyz:IIchapIIIsecII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig034}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig034.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig214.pdf}
  ...
  \section{Tok povrchem krychle. Gaussova věta}\hypertarget{fyz:IIchapIIIsecIII}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig215.pdf}
