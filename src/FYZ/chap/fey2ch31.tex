...
\chapter{Tenzory}\label{fyz:IIchapXXXI}
  ...
  \section{Elipsoid energie}\label{fyz:IIchapXXXIsecIII}
    ...
    \luagraphic[1]{fyz_fig875.pdf}{Množina koncových bodů vektoru \(\vec{E} = (E_x, E_y)\), který
    ...
    \begin{figure}[ht!] %\ref{fyz:fig876}
      \centering
      \includegraphics[width=0.5\linewidth]{fyz_fig876.pdf}
