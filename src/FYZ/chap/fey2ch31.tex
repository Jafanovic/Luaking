...
\chapter{Tenzory}\label{fyz:IIchapXXXI}
  ...
  \section{Tenzor napětí}\label{fyz:IIchapXXXIsecVI} 
    ...
    \begin{figure}[ht!] %\ref{fyz:fig878}
      \centering
      \subcaptionbox{\label{fyz:fig298a}}{\luafigure[0.45]{fyz_fig878a.pdf}}
      \subcaptionbox{\label{fyz:fig298b}}{\luafigure[0.45]{fyz_fig878b.pdf}}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig879}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig879.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig880}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig880.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig881}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig881.pdf}
