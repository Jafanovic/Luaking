...
\chapter{Polarizace}\label{fyz:IchapXXXIII}
  \section{Elektrický vektor světla}\label{fyz:IchapXXXIIIsecI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig270}
      \centering
      \subcaptionbox{\(E_y = 1\;  E_x = 0\)           \label{fyz:fig270a}}
        {\luafigure[0.4]{fyz_fig270a.pdf}}               
      \subcaptionbox{\(E_y = 1\;  E_x = \frac{1}{2}\) \label{fyz:fig270b}}
        {\luafigure[0.4]{fyz_fig270b.pdf}}                                                 \\
      \subcaptionbox{\(E_y = 1\;  E_x = 1\)           \label{fyz:fig270c}}
        {\luafigure[0.4]{fyz_fig270c.pdf}}                         
      \subcaptionbox{\(E_y = 0\;  E_x = 1\)           \label{fyz:fig270d}}
        {\luafigure[0.4]{fyz_fig270d.pdf}}                                                 \\         
      \subcaptionbox{\(E_y = 1\;  E_x = -1\)          \label{fyz:fig270e}}
        {\luafigure[0.4]{fyz_fig270e.pdf}}                         
      \subcaptionbox{\(E_y = -1\; E_x = 1\)           \label{fyz:fig270f}}
        {\luafigure[0.4]{fyz_fig270f.pdf}}
      \caption{Skládání kmitů ve směru os \(x\) a \(y\) ve fázi (\cite[s.~437]{Feynman01})}
      \label{fyz:fig270}
    \end{figure}

    Na obr. \ref{fyz:fig271} jsme označili vektory intenzity elektrického pole ve směrech \(x\) a
    ...
    \begin{figure*}[ht!]  %\ref{fyz:fig271}
      \centering
      \subcaptionbox{\(E_x=\cos\omega t; 1\\ E_y=\cos\omega t; 1\)\label{fyz:fig271a}}
        {\luafigure[0.2]{fyz_fig271a.pdf}}               
      \subcaptionbox{\(\cos\omega t; 1\\ 
         \cos(\omega t + \frac{\pi}{4}); e^{\imath\frac{\pi}{4}}\)\label{fyz:fig271b}}
        {\luafigure[0.2]{fyz_fig271b.pdf}}                             
      \subcaptionbox{\(cos\omega t; 1 \\ -\sin\omega t; \imath\)\label{fyz:fig271c}}
        {\luafigure[0.2]{fyz_fig271c.pdf}}                                                  
      \subcaptionbox{\(\cos\omega t; 1\\ \cos(\omega t + \frac{3\pi}{4}); 
        e^{\imath\frac{3\pi}{4}}\)\label{fyz:fig271d}}
        {\luafigure[0.2]{fyz_fig271d.pdf}}                                                  \\           
      \subcaptionbox{\(\cos\omega t; 1\\ -\cos\omega t; -1\)\label{fyz:fig271e}}
        {\luafigure[0.2]{fyz_fig271e.pdf}}               
      \subcaptionbox{\(\cos\omega t; 1\\ -\cos(\omega t + \frac{\pi}{4}); 
        -e^{\imath\frac{\pi}{4}}\)\label{fyz:fig271f}}
        {\luafigure[0.2]{fyz_fig271f.pdf}}   
      \subcaptionbox{\(\cos\omega t; 1\\ \sin\omega t; -\imath\)\label{fyz:fig271g}}
        {\luafigure[0.2]{fyz_fig271g.pdf}}               
      \subcaptionbox{\(\cos\omega t; 1\\ -\cos(\omega t + \frac{3\pi}{4}); 
        -e^{\imath\frac{3\pi}{4}}\)\label{fyz:fig271h}}{\luafigure[0.2]{fyz_fig271h.pdf}}   \\              
      \subcaptionbox{\(\cos\omega t; 1\\ \cos\omega t; 1\)\label{fyz:fig271i}}
        {\luafigure[0.2]{fyz_fig271i.pdf}}               
  ...
  \section{Dvojlom}\label{fyz:IchapXXXIIIsecIII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig272}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig272.pdf}
  ...
  \section{Polarizátory}\label{fyz:IchapXXXIIIsecIV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig273}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig273.pdf}
  ...
  \section{Optická aktivita}\label{fyz:IchapXXXIIIsecV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig274}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig274.pdf}
  ...
  \section{Intenzita odraženého světla}\label{fyz:IchapXXXIIIsecVI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig275}
      \centering
      \subcaptionbox{\label{fyz:fig275a}}{\luafigure[0.45]{fyz_fig275a.pdf}}
      \subcaptionbox{\label{fyz:fig275b}}{\luafigure[0.45]{fyz_fig275b.pdf}}
  ...
  \section{Anomální lom světla}\label{fyz:IchapXXXIIIsecVIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig276}
      \centering
      \subcaptionbox{\label{fyz:fig276a}}{\luafigure[0.8]{fyz_fig276a.pdf}} \\
      \subcaptionbox{\label{fyz:fig276b}}{\luafigure[0.8]{fyz_fig276b.pdf}}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig277}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig277.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig278}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig278.pdf}
