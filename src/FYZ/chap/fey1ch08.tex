...
\chapter{Pohyb}\label{fyz:IchapVIII}
  \luagraphic[1]{fyz_fig908.jpg}{Human cannonball: Hugo Zacchini (20. října 1898 - 20. října 1975), 
                 jeden z bratrů Zacchini, byl první lidskou dělovou koulí, vystřelený kanónem 
                 na stlačený vzduch.}{fyz:fig908}
  ...
  \section{Popis pohybu}\label{fyz:IchapVIIIsecI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig098}
      \centering
      \subcaptionbox{\label{fyz:fig098a}}{\luafigure[0.8]{fyz_fig098a.pdf}}              \newline                                                   
      \subcaptionbox{\label{fyz:fig098b}}{\luafigure[0.8]{fyz_fig098b.pdf}}
  ...
  \section{Zrychlení}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig099}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig099.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig100}
      \centering
