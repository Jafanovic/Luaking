...
\chapter{Charakteristiky síly}\label{fyz:IchapXII}
  ...
  \section{Tření}\label{fyz:IchapXIIsecII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0121}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0121.pdf}
    ...
    \begin{equation}\label{fyz:eq169}
      \boxed{F = \mu N}\,.
    \end{equation}
    kde \(\mu\) je \textbf{koeficient smykového tření} (obr. \ref{fyz:fig0121}). Ačkoli tento 
  ...
  \section{Molekulové síly}\label{fyz:IchapXIIsecIII}
    ...
    dvěma atomy je schematicky ilustrována na obr. \ref{fyz:fig0122}, kde je znázorněna jako funkce 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0122}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0122.pdf}
    ...
    vzdálenostech, jak je to vidět na obr. \ref{fyz:fig0122}, můžeme vytvořit pevné látky, v nichž 
    ...
    obr. \ref{fyz:fig0122} protíná osu) jsou síly nulové, což znamená, že všechny jsou v rovnováze, 
    ...
    malou vzdálenost} než je \(d\), je odpovídající délka křivky na obr. \ref{fyz:fig0122} také 
    ...
    celkové prodloužení, způsobené řekněme \qty{100}{\g} závažím, zjistíme, že dalších \qty{100}{\g} 
    způsobí dodatečné prodloužení, jež se téměř rovná výchylce způsobené prvním \qty{100}{\g} 
  ...
  \section{Fundamentální síly, pole}\label{fyz:IchapXIIsecIV}
    ...
    rovna (\(\left(\num{1.52e-14}\right)^2\)). Výhodou užití této konstanty je, že sílu mezi dvěma
    elektrony v newtonech lze zapsat jako \(e^2/r^2\) (\(r\) udáváme v metrech), bez jednotlivých
    konstant. Elektrické síly jsou mnohem komplikovanější než naznačuje tento vztah, neboť tento
    vztah dává sílu mezi dvěma náboji, jen jsou-li v klidu. Později si všimneme i obecnějšího
    případu.
    ...
    pomocí experimentu s obrazovkou (obr. \ref{fyz:fig0123}). Na jednom konci obrazovky je zdroj, 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0123}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0123.pdf}
    ...
    bod je stále posunutý směrem nahoru, nyní však otočme magnet o \qty{180}{\degree} kolem svislé 
  ...
  \section{Nepravé síly}\label{fyz:IchapXIIsecVI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0124}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0124.pdf}
      \caption{Ilustrace nepravé síly (\cite[s.~181]{Feynman01})}
      \label{fyz:fig0124}
    \end{figure}
  ...
  \section{Jaderné síly}\label{fyz:IchapXIIsecVII}
    ...
    velmi krátký dosah, přibližně takový, jako je rozměr jádra, asi \qty{e-15}{\m}. Pro tak malé 
    ...
    vzdálí na větší vzdálenost, ačkoli v dosahu \qty{e-15}{\m} jsou velmi silné. Podle současného 
