...
\chapter{Elektřina v atmosféře}\label{fyz:IIchapIX}  
  ...
  \section{Gradient elektrického potenciálu v atmosféře}\label{fyz:IIchapIXsecI}  
    ...
    elektrické pole \(E\) s velikostí \qty{100}{\V\per\m}. Směr pole je takový, jako kdyby zemský
  ...
  \section{Elektrické proudy v atmosféře}\label{fyz:IIchapIXsecII}   
    ...
    malé, pohybují se ve vzduchu rychle - rychlostí asi \qty{1}{\cm\per\s} v poli \qty{100}{\V\per\m}
    neboli \qty{1}{\V\per\cm}. Mnohem větší a hmotnější ionty se pohybují mnohem pomaleji. Ukazuje
    ...
    hovoříme, se vzduch ve výšce asi \qty{50}{\km} vlastně stává vodičem. To ještě není výška
    odpovídající tomu, co se nazývá \emph{ionosféra}, v níž vznikají velká množství iontů v důsledku
    fotoelektrických účinků slunečního záření. Ve výšce přibližně \qty{50}{\km} se stává vzduch
    ...
    9.5Proudse mění asi o \qty{\pm15}{\percent} a maxima dosahuje v sedm večer londýnského času.
    ...
    večer. Na celém světě je proud v maximu v \qty{7.00}{\hour} večer londýnského času a v minimu ve
    \qty{4.00}{\hour} ráno londýnského času.
    ...
    víme, že napětí horní vrstvy atmosféry klesá a stoupá o \qty{15}{\percent} v závislosti na
  ...
  \section{Původ atmosférických proudu}\label{fyz:IIchapIXsecIII} 
    ...
    \qty{1800}{\A}, jenž se potom vybíjí v oblastech s klidným počasím.
  ...
  \section{Bouřky}\label{fyz:IIchapIXsecIV}   
    ...
    vzestupný proud rychlostí přibližně \qty{100}{\km\per\hour}. Když je vodní pára unášena vzhůru
  ...
  \section{Mechanismus oddělování nábojů}\label{fyz:IIchapIXsecV} 
    ...
    je teplota vzduchu asi \qty{-20}{\degreeCelsius}, zatímco záporné náboje jsou ve výšce
    ...
    elektrickém poli s intenzitou asi \qty{100}{\V\per\m} k záporně nabité Zemi. Kapka bude mít
  ...
  \section{Blesk}\label{fyz:IIchapIXsecVI}   
    ...
    pohybuje dolů. Projde pouze zhruba 50 m a zastaví se. Stojí asi \qty{50}{\us} a potom provede
    ...
    stupňovitý vůdčí výboj dostane do výšky asi \qty{100}{\m} od země, zvedá se k němu z povrchu Země
