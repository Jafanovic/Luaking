...
Maxwell}
  \section{Možnost a pravděpodobnost}
    ...
    na ně podívali), je pravděpodobnost vytažení určité barvy \sfrac{1/7}. Pravděpodobnost, že ze 
    zamíchané hromady \num{52} karet „naslepo“ vytáhneme právě srdcové eso je rovna \sfrac{1/52}. 
    Pravděpodobnost hodu dvojnásobné jednotky při hře v kostky je \sfrac{1/36}.
  ...
  \section{Fluktuace}
    ...
    \begin{enumerate}[noitemsep]
      \item pravděpodobnost padnutí dvou hlav je \sfrac{1}{4}, 
      \item pravděpodobnost padnutí jedné hlavy je \sfrac{2/4}, 
      \item pravděpodobnost, že nepadne hlava je \sfrac{1}{4}. 
    \end{enumerate}
    ...
    pravděpodobnosti jsou \sfrac{1/8}, \sfrac{3/8}, \sfrac{3/8}, \sfrac{1/8}.
  ...
  \section{Rozložení pravděpodobnosti}
    ...
    plynu uzavřené v typické nádobě (která má objem např. \qty{1}{\litre}), jde vlastně o velmi 
