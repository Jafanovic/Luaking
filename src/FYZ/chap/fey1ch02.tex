  ...
  \section{Člověk a příroda}\label{fyz:IchapIIsecI}
    \subsection{Co je fyzika}\label{fyz:IchapIIsecIssecI}
      ...
      \luagraphicx[1]{fyz_fig0943c.jpg}{Zdeněk Burian: Tábor pozdně paleolitických lovců:
        ...
        nejstaršího a nejdelšího (\SI{99}{\percent}) období lidských dějin. Paleolit začal v době,
...
%---------------------------------------------------------------------------------------------------  
  \section{Moderní fyzika}\label{fyz:IchapIIsecIV}
    ...
    \luagraphicx[1]{fyz_fig0955.jpg}{Mezinárodní vesmírná stanice (anglicky International Space
      ...
      Země ve výšce kolem 400 km. Při průměrné rychlosti okolo \SI{7700}{\m\per\s}
      (\SI{27720}{\km\per\hour}) pak pravidelně obíhá Zemi s periodou cca 92 minut. Na fotografii je
      zachycena stanice z odlétajícího raketoplánu, dne 17. dubna 2010. Kredit:
