  ...
  \section{Člověk a příroda}\label{fyz:IchapIIsecI}
    \subsection{Co je fyzika}\label{fyz:IchapIIsecIssecI}
      ...
      \luagraphicx[1]{fyz_fig0943c.jpg}{Zdeněk Burian: Tábor pozdně paleolitických lovců:
        ...
        nejstaršího a nejdelšího (\qty{99}{\percent}) období lidských dějin. Paleolit začal v době,
    ...
    \subsection{Vývoj fyziky}\label{fyz:IchapIIsecIssecII}     
      ...
      rychlostmi blízkými rychlosti světla ve vakuu \(c=\qty{300000}{\km\per\s}\). Klesne-li jejich
      ...
      \qty{6.626e-34}{\joule\s}\). Pokud můžeme tuto konstantu považovat za zanedbatelně malou,
    ...
    \subsection{Člověk}\label{fyz:IchapIIsecIssecIII}
      ...
      \ref{vol03:fyz:fig0916} v kapitole \ref{vol03:kulIchIIsecI} \uv{Naše Galaxie}) je sluneční soustava, a
...
%--------------------------------------------------------------------------------------------------- 
  \section{Klasická fyzika}\label{fyz:IchapIIsecIII}
    ...
    sto kmitů za sekundu. Zvýšíme-li frekvenci na \qty{500}{\kHz} nebo \qty{1000}{\kHz} (\qty{1}{\kHz}
    ...
    pohybovat nabitým hřebenem tak rychle, aby kmital s frekvencemi od \qty{5e14}{\Hz} do
    \qty{5e15}{\Hz}, viděli bychom toto kmitání jako červené, modré nebo fialové světlo v závislosti
    ...
    ještě vyšších frekvencí, řekněme \qty{10e24}{\Hz}, lze získat uměle, například na
  ...
  \section{Moderní fyzika}\label{fyz:IchapIIsecIV}
    \subsection{Kořeny nové fyziky}\label{fyz:IchapIIsecIVssecI}
      ...
      \subsubsection{Problém spektrálních čar atomů}\label{fyz:IchapIIsecIVssecIsssecIII}
        ...
        \qty{656.2}{\nm} (červená), \qty{486.1}{\nm} (modrá), \qty{434.0}{\nm} (modrofialová),
        \qty{410.1}{\nm} (fialová) a dále se čáry zhušťovaly až k hraně \qty{364.6}{\nm}.
        ...
        \begin{description}[leftmargin=3em,labelindent=1em, style=nextline]
          ...
          \item \(B\) je konstanta o hodnotě \qty{364.506802}{\nm}
          \item \(m\) je rovno \num{2}
        ...
        \luagraphicx[1]{fyz_fig0945.jpg}{„Viditelné“ čáry spektra emise vodíku v sérii Balmer.
          ...
          ultrafialové, protože mají vlnové délky menší než \qty{400}{\nm}. Kredit:
      ...
      Slunce, tedy v kosmickém éteru, rychlosti přibližně \qty{30}{\km\per\s}, desettisíckrát
      ...
      \begin{tcnote}
        ...
        rotujícím osmibokým skleněným hranolem a chyba měřeni činila \qty{60}{\km\per\s}. Po 42
        letech se k měření vrátil a nechal světlo procházet po dráze \qty{35}{\km} mezi vrcholy hor
        Mount Wilson a Mount San Antonio v Kalifornii. Tentokrát činila chyba jen \qty{4}{\km\per\s}.
      ...
      tomto směru. Sama zeměkoule se přitom zploští o neuvěřitelně malou veličinu asi \qty{6}{\cm}.
      ...
      \subsubsection{Planck}\label{fyz:IchapIIsecIVssecIsssecVI}
        ...
        která je nepřímo úměrná teplotě. Tak lidské tělo o teplotě \qty{300}{\K} vyzařuje s maximální
        intenzitou na vlnové délce \qty{10}{\mm} v daleké infračervené oblasti (a může být detekováno
        termovizí). Slunce o povrchové teplotě \qty{6000}{\K} září na vlnové délce kolem
        ...
        \textbf{Boltzmannova konstanta} \( k = \qty{1.380649e-23}{\joule\per\kelvin}\) (přesně) a
        \textbf{Planckova konstanta} \(h = \qty{6.62607015e-34}{\joule\s} \) (přesně). Elementární
      ...
      \subsubsection{Einstein a kosmos}\label{fyz:IchapIIsecIVssecIsssecVIII}
        ...
        \qty{240}{\cm} za 2 miliardy dolarů, který byl v březnu 1990 umístěn na oběžnou dráhu kolem
        ...
        že pozorujeme pouhá \qty{4}{\percent} hmoty ve vesmíru, dalších \qty{22}{\percent} tvoří už
        zmíněná temná gravitující hmota v galaxiích a celých \qty{74}{\percent}  antigravitující
        ...
        o délce \qty{5.6}{\km}. Jocelyn si všimla, že z některých zdrojů na obloze přicházejí velmi
        ...
        oběžné periody o \qty{0.04}{\s} za rok. Toto zkracování je způsobeno tím, že pulzar neustále
    ...
    \subsection{Kvantová Fyzika}\label{fyz:IchapIIsecIVssecII}
      ...
      \(\Delta x \Delta p \frac{\hbar}{2\pi}\). Podrobněji bude o tomto principu mluveno později.
      Vysvětluje se tím velmi záhadný paradox: jsou-li atomy složeny z kladných a záporných nábojů,
      proč se záporný náboj prostě neusadí na kladném náboji (tyto náboje se přitahují) a to tak
      těsně, že by ho úplně vyrušil? \emph{Proč jsou atomy tak velké}? Proč je jádro uprostřed a
      elektrony okolo něho? Zpočátku se myslelo, že příčinou je velký rozměr jádra; jenže jádro je
      velmi malé. Atom má průměr okolo \qty{10e-10}{\meter}. Jádro má průměr asi \qty{10e-15}{\meter}.
      ...
      v oblasti frekvencí nad \qty{10e12}{\Hz} nebyl zatím zjištěn žádný jev přímo související s
    ...
    \subsection{Atom}\label{fyz:IchapIIsecIVssecIII}
      ...
      poloměrem \qty{30}{\pm}. \uv{Mlha} znároňuje  elektronový obal, sestávající z
      ...
      centrum (jádro představuje \qty{99.9}{\percent} hmotnosti atomu). Průměr jádra
      činí přibližně \qty{10e-15}{\m}, což je přibližně \(\num{100 000}\times\) méně
    ...
    \luagraphicx[1]{fyz_fig0955.jpg}{Mezinárodní vesmírná stanice (anglicky International Space
      ...
      Země ve výšce kolem 400 km. Při průměrné rychlosti okolo \qty{7700}{\m\per\s}
      (\qty{27720}{\km\per\hour}) pak pravidelně obíhá Zemi s periodou cca 92 minut. Na fotografii
      je zachycena stanice z odlétajícího raketoplánu, dne 17. dubna 2010. Kredit:
      Wikipedia}{fyz:fig0955}
