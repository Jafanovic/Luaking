...
\chapter{Magnetostatika}\label{fyz:IIchapXIII}
  ...
  \section{Magnetické pole}\label{fyz:IIchapXIIIsecI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0061}
      \centering
      \includegraphics[width=0.3\linewidth]{fyz_fig0061.pdf}
    ...
    \subsection{Elektrický proud, zachování náboje}
      ...
      \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.7\linewidth]{fyz_fig0216.pdf}
      ...
      \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.5\linewidth]{fyz_fig0217.pdf}
      ...
      \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.5\linewidth]{fyz_fig0218.pdf}
    ...
    \subsection{Magnetická síla působící na proud}
      ...
      \begin{figure}[ht!]
        \centering
        \subcaptionbox{\label{fyz:fig0219a}}{\luafigure[0.45]{fyz_fig0219a.pdf}}
        \subcaptionbox{\label{fyz:fig0219b}}{\luafigure[0.45]{fyz_fig0219b.pdf}}
    ...
    \subsection{Magnetické pole stacionárních proudů, Ampérův zákon}
      ...
      \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.7\linewidth]{fyz_fig0220.pdf}
  ...
  \section{Magnetické pole přímého vodiče a solenoidu. Atomové proudy}\label{fyz:IIchapXIIIsecV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0683}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0683.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0684}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0684.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0685}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0685.pdf}
  ...
  \section{Magnetická a elektrická pole v teorii relativity}\label{fyz:IIchapXIIIsecVI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0686}
      \centering
      \subcaptionbox{\label{fyz:fig0686a}}{\luafigure[1]{fyz_fig0686a.pdf}} \\
      \subcaptionbox{\label{fyz:fig0686b}}{\luafigure[1]{fyz_fig0686b.pdf}}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0686}
      \centering
      \subcaptionbox{\label{fyz:fig0687a}}{\luafigure[1]{fyz_fig0687a.pdf}} \\
      \subcaptionbox{\label{fyz:fig0687b}}{\luafigure[1]{fyz_fig0687b.pdf}}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0688}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0688.pdf}
