...
\chapter{Algebra}\label{fyz:IchapXXII}
  ...
  \section{Komplexní čísla}\label{fyz:IchapXXIIsecV}     
    ...
    \(\imath\)}. Také \(-\imath\) je právě tak dobré řešení; neboť jediná deﬁnice \(\imath\) je, že
    ...
    Třeba řeknete: „Tak bychom mohli pokračovat do nekonečna! Deﬁnovali jsme mocniny imaginárních
  ...
  \section{Imaginární exponenty}\label{fyz:IchapXXIIsecVI}
    ...
    Tečky na obr \ref{fyz:fig414} představují hodnoty z tab. \ref{fyz:tab013}. Pro lepší představu
    ...
    \begin{figure}[ht!] %\ref{fyz:fig413}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig413.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig414}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig414.pdf}
  ...
  \section{Komplexní čísla v Matlabu}\label{fyz:IchapXXIIsecVII}
    ...
    \luagraphic[1]{fyz_fig932.pdf}{Kompasový graf vektorů jako šipek z počátku souřadnic 
      (\cite[s.~91]{Karban2006}}{fyz:fig932}
