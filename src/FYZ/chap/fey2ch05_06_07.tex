...
\section{Stabilita atomů}\label{fyz:IIchapVsecIII}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0188}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0188.pdf}
...
\section{Pole nabité přímky}\label{fyz:IIchapVsecIV}
  ...
  \luagraphic[0.9]{fyz_fig0046.pdf}{Válcová gaussovská plocha s nabitou přímkou v ose}{fyz:fig0046}
...
\section{Je pole bodového náboje přesně přímo úměrné veličině 
  ...
  \begin{figure}[hb!]
    \centering
    \subcaptionbox{\label{fyz:fig0194a}}{\luafigure[0.45]{fyz_fig0194a.pdf}}
    \subcaptionbox{\label{fyz:fig0194b}}{\luafigure[0.45]{fyz_fig0194b.pdf}}                      
...
\section{Metoda elektrostatického zobrazení}\label{fyz:IIchapVsecXVI}
  ...
  \subsection{Bodový náboj v blízkosti vodivé roviny} %\label{fyz:IIchapVsecXVII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0163}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0163.pdf}
...
\section{Kondenzátory, rovnoběžné desky}\label{fyz:IIchapVsecXIX}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0165}
    \centering
    \includegraphics[width=1\linewidth]{fyz_fig0165.pdf}
