...
V elektrostatice platí dva zákony: 
\begin{description}[leftmargin=0em,labelindent=0em, style=nextline]
  \item[Gaussův zákon]  Tok elektrického pole z objemu je přímo úměrný náboji v něm. 
  \item[Vektorové pole elektricky intenzity je gradientem] Cirkulace elektrického pole je rovna nule.
\end{description}

Z těchto dvou zákonů vyplývají v elektrostatice všechny předpovědi. Ale vyjádřit tyto zákony
matematicky je jedna věc a používat je snadno a s určitou dávkou důvtipu je věc druhá. V této
kapitole probereme řadu výpočtů, které je možné provést pomocí Gaussova zákona. Dokážeme některé
věty a popíšeme některé jevy, zejména ve vodičích, které je možno na základě tohoto zákona velmi
snadno pochopit. Samotný Gaussův zákon však nemůže poskytnout řešení žádné úlohy, neboť je třeba
respektovat ještě druhý zákon. Proto, když budeme používat Gaussův zákon k řešení konkrétních úloh,
musíme k němu ještě něco přidat: Budeme muset například udělat nějaký předpoklad o tom, jak vypadá
pole, založený například i na požadavcích symetrie. Anebo budeme muset explicitně zavést představu,
že pole je gradientem potenciálu \cite[s.~82]{Feynman02}.
...
\section{Rovnováha v elektrostatickém poli}\label{fyz:IIchapVsecI}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0186}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0186.pdf}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0187}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0187.pdf}
...
\section{Stabilita atomů}\label{fyz:IIchapVsecIII}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0188}
    \centering
    \includegraphics[width=0.8\linewidth]{fyz_fig0188.pdf}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0189}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0189.pdf}
...
\section{Pole nabité přímky}\label{fyz:IIchapVsecIV}
  ...
  \luagraphic[0.8]{fyz_fig0046.pdf}{Válcová gaussovská plocha s nabitou přímkou v ose}{fyz:fig0046}
...
\section{Nabitá rovina, dvě roviny}\label{fyz:IIchapVsecV}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0191}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0191.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0192}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0192.pdf}
...
\section{Nabitá koule, kulová slupka}\label{fyz:IIchapVsecVI}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0047}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0047.pdf}
...
\section{Je pole bodového náboje přesně přímo úměrné veličině 
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0193}
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0193.pdf}
  ...
  \begin{figure}[hb!]
    \centering
    \subcaptionbox{\label{fyz:fig0194a}}{\luafigure[0.7]{fyz_fig0194a.pdf}}  \\
    \subcaptionbox{\label{fyz:fig0194b}}{\luafigure[0.7]{fyz_fig0194b.pdf}}                      
  ...
  dosaženo záporného výsledku. Z geometrie aparatury a citlivosti elektrometru je možné vypočítat,
  jaké nejmenší pole by se projevilo. Z této hodnoty lze stanovit horní ohraničení odchylky
  mocnitele od dvou. Napíšeme-li, že elektrostatická síla je úměrná \(r^{2+\varepsilon}\), můžeme
  určit horní hranici pro \(\varepsilon\). Touto metodou Maxwell určil, že \(\varepsilon\) je méně
  než \(\sfrac{1}{10 000}\). V roce 1936 Plimpton a Laughton experiment zopakovali a zdokonalili.
  Zjistili, že mocnitel se liší od dvou o méně než jednu miliardtinu.
  ...
  (\qty{10e-10}{\meter}), Souhlasí mocnitel opět s přesností jedné miliardtiny.
  
  Přesnost Lambova-Retherfordova měření znovu umožnila fyzikální „náhoda“. Ze stavů atomu vodíku by
  dva měly mít téměř stejné energie, ale jen tehdy, mění-li se potenciál přesně jako \(1/r\). Tento
  velmi malý rozdíl jejich energií se měřil zjišťováním úhlové frekvence \(\omega\) fotonů
  emitovaných nebo absorbovaných při přechodech mezi těmito dvěma stavy na základě vztahu pro rozdíl
  energie \(\Delta E = \hbar\omega\)). Výpočty ukázaly, že \(\delta E\) by se zřetelně odlišovalo od
  naměřené hodnoty, kdyby se mocnitel v zákoně síly \(1/r^2\) lišil od dvou už o víc než jednu
  miliardtinu.
  
  Je tentýž mocnitel správný i pro kratší vzdálenosti? Z měření v jaderné fyzice se zjistilo, 
  že v typických jaderných vzdálenostech, zhruba \qty{10e-15}{\meter}, se uplatňují 
  ...
  ještě platí, alespoň v takové míře, i pro vzdálenosti řádu \qty{10e-10}{\meter}.
  
  A co při \qty{10e-16}{\meter}? Tento dosah je možné zkoumat ostřelováním protonů elektrony s 
  ...
  než \qty{10e-16}{\meter} asi 10-krát slabší. Jsou dvě možná vysvětlení. Jedno je, že v 
  ...
  \qty{1}{\meter}, ale i pro \qty{10e-10}{\meter}; zůstává však činitel 
...
\section{Pole vodiče}\label{fyz:IIchapVsecVIII}
  ...
  \begin{figure}[ht!]  % \ref{fyz:fig0195}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0195.pdf}
...
\section{Pole v dutině vodiče}\label{fyz:IIchapVsecIX}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0196}
    \centering
    \includegraphics[width=0.8\linewidth]{fyz_fig0196.pdf}
...
\twocolumn[\section{Elektrické pole v různých případech}\label{fyz:IIchapVsecX}]
...
\section{Elektrický dipól}\label{fyz:IIchapVsecXI}
  ...
  náboje (obr. \ref{fyz:fig0197}). Pak podle (\ref{fyz:eq1007a}) je potenciál obou nábojů
  \begin{align}
    \varphi(x,y,z) 
  ...
  \end{align}
  \begin{figure}[ht!] %\ref{fyz:fig0197}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0197.pdf}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0160}
    \centering
    \includegraphics[width=0.4\linewidth]{fyz_fig0160.pdf}
  ...
  \begin{figure}[ht!] % \ref{fyz:fig0198}
    \centering
    \includegraphics[width=0.5\linewidth]{fyz_fig0198.pdf}
  ...
  \begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0199.pdf}
...
\twocolumn[\section{Potenciál dipólu jako gradient}\label{fyz:IIchapVsecXIII}]
  ...
  \begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\linewidth]{fyz_fig0159.pdf}
  ...
  \begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0200.pdf}
...
\twocolumn[\section{Dipólové přiblížení pro libovolné rozdělení náboje}\label{fyz:IIchapVsecXIV}]
  ...
  \begin{figure}[ht!]   %\ref{fyz:fig0158}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0158.pdf}
...
\section{Metoda elektrostatického zobrazení}\label{fyz:IIchapVsecXVI}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0161}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0161.pdf}
  ...
  Podle toho můžeme pole na obr. \ref{fyz:fig0162} vypočítat tak, že vypočteme pole pocházející od
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0162}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0162.pdf}
  ...
  \subsection{Bodový náboj v blízkosti vodivé roviny} %\label{fyz:IIchapVsecXVII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0163}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig0163.pdf}
  ...
  \subsection{Bodový náboj v blízkosti vodivé koule}  %\label{fyz:IIchapVsecXVIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0164}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0164.pdf}
...
\section{Kondenzátory, rovnoběžné desky}\label{fyz:IIchapVsecXIX}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0165}
    \centering
    \includegraphics[width=0.9\linewidth]{fyz_fig0165.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0166}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0166.pdf}
...
\section{Průraz při vysokém napětí}\label{fyz:IIchapVsecXX}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0167}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0167.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0168}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0168.pdf}
...
\section{Emisní mikroskop}\label{fyz:IIchapVsecXXI}  
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0169}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0169.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0936}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0936.png}
...
\twocolumn[\section{Metody určování elektrostatického pole}\label{fyz:IIchapVsecXXII}]
  ...
  na \(z\), jde o dvojrozměrnou úlohu. Protože ve dvojrozměrné úloze je \(\diffp{}{z}=0\), je
  rovnice pro \(\varphi\) ve volném prostoru
...
\twocolumn[\section{Dvojrozměrné pole jako funkce komplexní proměnné}\label{fyz:IIchapVsecXXIII}]
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0170}
    \centering
    \includegraphics[width=1\linewidth]{fyz_fig0170.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0171}
    \centering
    \includegraphics[width=0.9\linewidth]{fyz_fig0171.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0172}
    \centering
    \includegraphics[width=0.9\linewidth]{fyz_fig0172.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0173}
    \centering
    \includegraphics[width=0.9\linewidth]{fyz_fig0173.pdf}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0174}
    \centering
    \includegraphics[width=0.8\linewidth]{fyz_fig0174.pdf}
...
\section{Kmity v plazmatu}\label{fyz:IIchapVsecXXIV} 
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0175}
    \centering
    \includegraphics[width=0.9\linewidth]{fyz_fig0175.pdf}
  ...
  \begin{equation}\label{fyz:eq850} 
    e^2=\dfrac{q^2_e}{4π\varepsilon_0}=\qty{2.3068e-28}{\newton\square\m}.
  \end{equation}
...
\section{Koloidní částice v elektrolytu}\label{fyz:IIchapVsecXXV}
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0176}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0176.pdf}
...
\section{Elektrostatické pole mřížky}\label{fyz:IIchapVsecXXVI} 
  ...
  \begin{figure}[ht!]  %\ref{fyz:fig0177}
    \centering
    \includegraphics[width=0.7\linewidth]{fyz_fig0177.pdf}
    \caption{Ekvipotenciální plochy nad pravidelnou mřížkou nabitých drátů
             (\cite[s.~136]{Feynman02}).}
    \label{fyz:fig0177}
  \end{figure}

  Viděli jsme (kapitola \ref{vol02:fyz:IchapL}, díl \ref{vol02:part:FYZI}), že každou periodickou veličinu je
