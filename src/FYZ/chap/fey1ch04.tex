...
\setchaptertoc
\chapter{Zachování energie}\label{fyz:IchapIV}
  \section{Co je to energie}
    ...
    vymyslela trik. Věděla, že každá kostka váží \qty{100}{\gram}, a tak zvážila krabici, když bylo 
    všech \num{28} kostek venku. Zjistila, že váží \qty{500}{\gram}, a proto při další kontrole 
    kostek zvážila opět krabici, odečetla \qty{500}{\gram} a dělila stem. Tak objevila zákonitost
    \begin{equation*}
      \resizebox{0.8\hsize}{!}{%
    ...
    vody byla \qty{15}{\cm} a každá kostka zvedala hladinu o \qty{0.5}{\cm}, nový vzorec má tvar
    \begin{gather*}
      \renewcommand{\arraystretch}{0.8}
        \begin{pmatrix} 
          \text{\footnotesize{počet}}   \\
  ...
  \section{Gravitační potenciální energie}
    ...
    znázorněném na obr. \ref{fyz:fig0052}. K otáčení šroubu slouží rukojeť dlouhá \qty{1}{\m} a šroub 
    ...
    přibližně \qty{628}{\cm}. Rukojeť tedy musí projít \qty{2512}{\cm}. Použijeme-li různé kladky 
    apod., budeme zvedat jednu tunu neznámým malým závažím o hmotnosti \(m\) působícím na konec 
    rukojeti. Tak zjistíme, že \(m\) je asi \qty{4}{\kg}. Takový je následek zákona zachování 
    energie.
    ...
    vzdálenost. Abychom si situaci zjednodušili, předpokládejme, že klesne o \qty{10}{cm}. Ptáme se, 
    jak se zvednou uvedená závaží. Střed tyče se zvedne o \qty{5}{\cm} a bod, který je ve čtvrtině 
    vzdálenosti od opory se zvedne o \qty{2.5}{\cm}. Potom princip, že součet součinů výšek a 
    hmotností těles se nemění, říká: hmotnost \(m\) krát \qty{10}{\cm} dolů, plus \qty{30}{\kg} krát 
    \qty{5}{\cm} nahoru, plus \qty{50}{\kg} krát \qty{2.5}{\cm} nahoru je roven nule
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0053}
      ...
      \label{fyz:fig0053}
    \end{figure}
    K vyvážení tyče je tedy třeba závaží o hmotnosti \qty{27.5}{\kg}. Takovým způsobem můžeme 
