...
\chapter{Úvodní kurz fyziky}\label{fyz:IchapI}
  ...
  \section{Látka se stává z atomů}
    ...
    \ref{fyz:fig0891} o rozměru \qty{0.5}{\cm}. Podí\-váme-li se na ni zblízka, neuvidíme nic jiného,
    ...
    jednoduchost jsou molekuly zakresleny tak, že atomy vodíku svírají úhel \qty{120}{\degree}. Ve
    skutečnosti má tento úhel hodnotu \ang[arc-separator = \,]{105;3;} a vzdálenost mezi středem
    vodíku a středem kyslíku je \qty{9.57e-11}{\m}. Tuto molekulu tedy velmi dobře známe.
  ...
  \subsection{Chemické reakce}
    ...
    \begin{figure}[hbt!]    % \ref{fyz:fig0892}
      ...
      \caption{ V knize \emph{Les Atomes} z roku 1916, kterou napsal nobelista Jean Baptiste Perrin,
                jsou publikovány tři stopy pohybu koloidních částic o poloměru \qty{0.53}{\um},
                pozorovaných pod mikroskopem. Postupné pozice jsou každých 30 sekund spojeny přímými
                segmenty (velikost ok síťe je \qty{3.2}{\um}. \cite[s.~115]{Perrin1914}}
      \label{fyz:fig0892}
    \end{figure}
