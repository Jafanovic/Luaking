...
\chapter{Základy fyziky}\label{fyz:IchapI}
  ...
  \subsection{Atomové procesy}
    ...
    \begin{figure}[ht!]  % \ref{fyz:fig013}
      \centering
        \subcaptionbox{Tabulka vzdáleností. \label{fyz:fig013a}}
          {\luafigure[0.4]{fyz_fig013a.pdf}}                                                      \\                                   
        \subcaptionbox{Vzdálenost nejbližších sousedů \(d = \dfrac{a}{2}\). \label{fyz:fig013b}}
          {\luafigure[0.7]{fyz_fig013b.pdf}}
  ...
  \subsection{Chemické reakce}
    ...
    \begin{figure}[ht!]   % \ref{fyz:fig014}
      \centering
