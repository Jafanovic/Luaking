  ...
  \subsection{Chemické reakce}
    ...
    \begin{figure}[hbt!]    % \ref{fyz:fig0892}
      ...
      \caption{ V knize \emph{Les Atomes} z roku 1916, kterou napsal nobelista Jean Baptiste Perrin,
                jsou publikovány tři stopy pohybu koloidních částic o poloměru
                \protect\SI{0.53}{\protect\um}, pozorovaných pod mikroskopem. Postupné pozice jsou
                každých 30 sekund spojeny přímými segmenty (velikost ok síťe je
                \protect\SI{3.2}{\protect\um}. \cite[s.~115]{Perrin1914}}
      \label{fyz:fig0892}
    \end{figure}
