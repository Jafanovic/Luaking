...
\chapter{Kinematika částice}
  ...
  \section{Kinematický popis pohybu částice}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=\linewidth]{fyz_fig0227.pdf}
    ...
    \subsubsection{Skládání harmonických pohybů v kolmých směrech}
      ...
      \begin{figure}
        \centering
        \subcaptionbox{$A=B$ a $\omega_1=\omega_2$. \label{fyz:fig0226a}}
            {\luafigure[0.31]{fyz_fig0226a.pdf}} 
        \subcaptionbox{$A=B$ a $\frac{\omega_1}{\omega_2}=\frac{2}{3}$. \label{fyz:fig0226b}}
            {\luafigure[0.50]{fyz_fig0226b.pdf}}
