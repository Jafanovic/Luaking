...
\chapter{Zákony termodynamiky}\label{fyz:IchapXLIV}
  ...
  \section{Entropie}\label{fyz:IchapXLIVsecVI}
    ...
    a říkáme, že „ve vratném cyklu je změna entropie nulová“. Když \(T\) je \qty{1}{\celsius}, pak je
    entropie \(\frac{Q}{\qty{1}{\celsius}}\), nebo, jak jsme již označili,
    \(\frac{Q}{\qty{1}{\celsius}} = S\). Opravdu \(S\) je písmeno, které nejčastěji používáme pro
    ...
    Dlouho se předpokládalo, že absolutní entropie neznamená nic a že je možné deﬁnovat pouze
