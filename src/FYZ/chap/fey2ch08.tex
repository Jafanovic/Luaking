...
\chapter{Elektrostatická energie}\label{fyz:IIchapVI}
  ...
  \twocolumn[\section{Elektrostatická energie iontového krystalu}\label{fyz:IIchapVIsecIII}] 
    ...
    Vzdálenost mezi sousedními ion tyje \qty{0.281}{\nm} (=\qty{2.81e-10}{\m}).
    ...
    \begin{align*}
      N_0 &= \qty{6.02e23}{\per\mole},  \\
      \shortintertext{energii vypařování napíšeme takto:}
      W   &= \qty{7.64}{\joule\per\mole}.
    \end{align*}
    ...
    ionty.) Tato energie je rovna \qty{5.12}{\electronvolt}, což, jak už vidíme, by nám mělo
    ...
    \qty{5.12}{\electronvolt}\), 
    \begin{equation*}
      W=−\qty{8.94}{\electronvolt}.
    \end{equation*}

    Náš výsledek převyšuje asi o \qty{10}{\percent} experimentálně pozorovanou energii. To ukazuje,
    ...
    tento příspěvek od čisté elektrostatické energie, dostaneme \qty{7.99}{\electronvolt} jako
    energii disociace připadající na jednu molekulu. Je to mnohem blíže k pozorované hodnotě
    \qty{7.92}{\electronvolt}, ale stále ještě ne dokonale shodné. Existuje ještě jedna věc, kterou
  ...
  \twocolumn[\section{Elektrostatická energie v atomových jádrech}\label{fyz:IIchapVIsecIV}]
    ...
    stav. První excitovaný stav má energii o \qty{2.14}{\mega\electronvolt} větší než stav základní,
    další energii o \qty{4.46}{\mega\electronvolt} vyšší než základní stav atd. Výzkum v jaderné
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0184}
      ...
      \caption{Energetické hladiny jader \ce{^{11}B} a \ce{^{11}C} (hodnty udané v
        \unit{\mega\electronvolt}). Základní stav \ce{^{11}C} leží o \qty{1.982}{\mega\electronvolt}
        výše než základní stav \ce{^{11}B} (\cite[s.~149]{Feynman02}).
      }
      \label{fyz:fig0184}
    \end{figure}
    ...
    jádrech. První excitované stavy jsou asi \qty{2}{\mega\electronvolt} nad základními stavy.
    Následuje velká mezera asi \qty{2.3}{\mega\electronvolt} k druhému excitovanému stavu, potom malý
    skok pouze \qty{0.5}{\mega\electronvolt} k třetí hladině. Mezi čtvrtou a pátou hladinou je opět
    velký skok, ale mezi pátou a šestou pouze maličká mezera řádu\qty{0.1}{\mega\electronvolt} atd.
    ...
    \qty{1.982}{\mega\electronvolt}. Všechny ostatní hladiny mají absolutní energii také větší o tuto
    ...
    To však není docela pravda. Rozdíl energií \qty{1.982}{\mega\electronvolt} mezi základními stavy
    ...
    tj.\qty{0.784}{\mega\electronvolt}. Rozdíl, který je třeba vysvětlit elektrostatickou energií, je
    tak větší než \qty{1.982}{\mega\electronvolt}:
    \begin{equation*}
      \num{1.982} + \num{0.784} = \qty{2.766}{\mega\electronvolt}
    \end{equation*}
    ...
    \begin{equation*}
      r=11^\frac{1}{3}\cdot\qty{1.2e-15}{\m} = \qty{2.7e-15}{\m}.
    \end{equation*}
    ...
    asi \qty{15}{\percent} (to není špatné na náš první jaderný výpočet!).
    ...
    malých rozměrech jako \qty{10e-15}{\m}. Druhý: přesvědčili jsme se o pozoruhodné shodě
