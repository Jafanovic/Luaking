...
\chapter{Harmonický oscilátor}\label{fyz:IchapXXI}
  ...
  \section{Harmonický oscilátor}\label{fyz:IchapXXIsecII}
    ...
    počet. Předpokládáme, že mezi tím nás na v kurzu \ref{mai:IchapV} z matematiké analýzy seznámili
  ...
  \twocolumn[\section{Harmonický pohyb a pohyb po kružnici}\label{fyz:IchapXXIsecIII}]
    ...
    \begin{figure}[ht!] %\ref{fyz:fig247}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig247_ver1.jpg}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig248}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig248_ver1.jpg}
