...
\chapter{Teorie gravitace}\label{fyz:chap_fey_gravity}
  ...
  \section{Newtonův gravitační zákon}
    ...
    \emph{horizontálně}, přece spadne za stejný čas o \SI{5}{\m}. Na obr. \ref{fyz:fig0058} je 
    ...
    horizontem. Na obr. \ref{fyz:fig0059} je znázorněna Země s jejím \SI{6380}{\km} dlouhým 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0089}
      ...
      \caption{Dostředivé zrychlení při kruhové dráze. Z podobnosti trojúhelníku: \(\frac{x}{s} = 
               ...
               (\protect\SI{6380}{\protect\km}), \(x\) je vzdálenost „prošlá horizontálně a za jednu
               sekundu a \(s\) je vzdálenost \uv{padání} za jednu sekundu (přibližně
               \protect\SI{5}{\protect\m}) \cite[s.~97]{Feynman01}}
       \label{fyz:fig0059}
    \end{figure}
