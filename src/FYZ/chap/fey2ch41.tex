...
\minitoc
  \section{Viskozita}\label{fyz:IIchapXLIsecI}
    ...
    \begin{figure}[ht!] %\ref{fyz_fig535}
      \centering
    ...
    \ref{fyz_fig535}), přičemž jednu z nich udržujeme v klidu a druhou pohybujeme rovnoběžně malou 
    ...
    prouděním (obr. \ref{fyz_fig536}). Smyková síla, která působí na tento hranolek, je
    \begin{equation}\label{fyz:eq570}
      \dfrac{\Delta F}{\Delta S} = \eta\dfrac{\Delta v_x}{\Delta y} = \eta\pder{v_x}{y}.
    \end{equation}
    \begin{figure}[ht!] %\ref{fyz_fig536}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz_fig537}
      \centering
  ...
  \section{Obtékání kruhového válce}\label{fyz:IIchapXLIsecIV}
    ...
    \begin{figure}[ht!] %\ref{fyz_fig538}
      \centering
    ...
    \begin{figure}[ht!] %\ref{fyz_fig539}
      \centering
    ...
    \begin{figure}[hb!] %\ref{fyz:fig540}
      ...
      \begin{tabular}{c}
       \subfloat[ ]{\label{fyz:fig540a}
         \includegraphics[width=0.7\linewidth]{fyz_fig540a.pdf}}  \\
       \subfloat[ ]{\label{fyz:fig540b}
         \includegraphics[width=0.7\linewidth]{fyz_fig540b.pdf}}  \\
       \subfloat[ ]{\label{fyz:fig540c}
         \includegraphics[width=0.7\linewidth]{fyz_fig540c.pdf}}  \\
       \subfloat[ ]{\label{fyz:fig540d}
         \includegraphics[width=0.7\linewidth]{fyz_fig540d.pdf}}  \\
       \subfloat[ ]{\label{fyz:fig540e}
         \includegraphics[width=0.7\linewidth]{fyz_fig540e.pdf}}  
      \end{tabular}
    ...
    \begin{figure}[ht!] %\ref{fyz_fig541}
      \centering
    ...
    \begin{figure}[hb!] %\ref{fyz:fig542}
      ...
      \begin{tabular}{cc}
       \subfloat[ ]{\label{fyz:fig542a}
         \includegraphics[width=0.4\linewidth]{fyz_fig542a.pdf}}  &
       \subfloat[ ]{\label{fyz:fig542b}
         \includegraphics[width=0.4\linewidth]{fyz_fig542b.pdf}}  \\
      \end{tabular}
    ...
    \begin{figure}[hb!] %\ref{fyz:fig543}
      ...
      \begin{tabular}{cc}
       \subfloat[ ]{\label{fyz:fig543a}
         \includegraphics[width=0.4\linewidth]{fyz_fig543a.pdf}}  &
       \subfloat[ ]{\label{fyz:fig543b}
         \includegraphics[width=0.4\linewidth]{fyz_fig543b.pdf}}  \\
       \subfloat[ ]{\label{fyz:fig543c}
         \includegraphics[width=0.4\linewidth]{fyz_fig543c.pdf}}  
      \end{tabular}
