...
\chapter{Elektrostatika}\label{fyz:IIchapIV}
  ...
  \section{Coulombův zákon, superpozice}\hypertarget{fyz:IIchapIVsecII}{}    
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig0202.pdf}
  ...
  \section{Elektrický potenciál}\label{fyz:IIchapIVsecIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig0044}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0044.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig0203a}}{\luafigure[0.8]{fyz_fig0203a.pdf}}   \\
      \subcaptionbox{\label{fyz:fig0203b}}{\luafigure[0.8]{fyz_fig0203b.pdf}}  
  ...
  \section{Tok pole \texorpdfstring{\(\vec{E}\)}{E}}\label{fyz:IIchapIVsecV}
    ...
    \begin{figure}[ht!]  % \ref{fyz:fig0204}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0204.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0205.pdf}
      \caption{Tok vektoru \(\vec{E}\) z plochy \(S\) je roven nule}
      \label{fyz:fig0205} 
    \end{figure}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig0206.pdf}
    ...
    \begin{figure}[ht!]
      \centering                  
      \includegraphics[width=0.9\linewidth]{fyz_fig0207.pdf}
