...
\chapter{Elektrostatika}\label{fyz:IIchapIV}
  ...
  \section{Elektrický potenciál}\label{fyz:IIchapIVsecIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig044}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig044.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig203a}}{\luafigure[0.45]{fyz_fig203a.pdf}}
      \subcaptionbox{\label{fyz:fig203b}}{\luafigure[0.45]{fyz_fig203b.pdf}}  
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig045}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig045.pdf}
  ...
  \section{Tok pole \texorpdfstring{\(\vec{E}\)}{E}}\label{fyz:IIchapIVsecV}
    ...
    \begin{figure}[ht!]
      \centering
      \subcaptionbox{\label{fyz:fig208a}}{\luafigure[0.45]{fyz_fig208a.jpg}}
      \subcaptionbox{\label{fyz:fig208b}}{\luafigure[0.45]{fyz_fig208b.jpg}}
  ...
  \section{Pole nabité koule}\label{fyz:IIchapIVsecVII}
    ...
    \ref{fyz:chap_fey_work} \ref{part:FYZI}. dílu tak, že jsme vypočítali integrál potenciálu a pak 
  ...
  \section{Siločáry, ekvipotenciální plochy}\label{fyz:IIchapIVsecVIII}
    ...
    mají všude směr vektoru pole (obr. \ref{fyz:fig210}). Jsou to tzv. siločáry. 
    \cite[s.~78]{Feynman02}
