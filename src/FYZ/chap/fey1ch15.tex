...
\chapter{Speciální teorie relativity}\label{fyz:IchapXV}
  \section{Co všechno patří k relativitě}\label{fyz:IchapXVsecI}
    ...
    \subsection{Trocha historie}
      ...
      \luagraphic[1]{fyz_fig907.jpg}{Klíčové osobnosti speciální relativity. Horní řada: Michelson,
        Morley, Einstein; dolní řada: Lorentz, Minkowski, Poincaré.
        (kredit:\aldebaranSTR)}{fyz:fig907}
      ...
      \subsection{Mezní rychlost}
        ...
        \luagraphic[1]{fyz_fig909.pdf}{Data Bertozziho experimentu ukazují úzkou shodu se
          speciální relativitou. Kinetická energie pěti elektronů probíhá: \num{0.5}, \num{1},
          \num{1.5}, \num{4.5}, \SI{15}{\mega\electronvolt} (nebo \num{1}, \num{2}, \num{3},
          \num{9}, \num{30} v \(mc^2\)). Rychlost: \num{0.752}, \num{0.828}, \num{0.922},
          \num{0.974}, \num{1.0} v \(c^2\) (nebo \num{0.867}, \num{0.910}, \num{0.960}, \num{0.987},
          \num{1} v \(c\)). Kredit:Wikipedia, \cite[s.~3]{Beiser1975} kapitola 35}{fyz:fig909} 
  ...
  \section{Měření událostí}
    ...
    \luagraphic[1]{fyz_fig910.pdf}{Řez trojrozměrným polem hodin a měřicích tyčí, kterými
    ...
    (\cite[s.~1009]{Halliday2001})}{fyz:fig910}
  ...
  \section{Relativita současnosti}
    ...
    \subsection{Bližší pohled na současnost}
      ...
      \begin{figure}[ht!]  %\ref{fyz:fig911}
        \centering
        \subcaptionbox{\label{fyz:fig911a}}{\luafigure[1]{fyz_fig911a.pdf}} \\    
        \subcaptionbox{\label{fyz:fig911b}}{\luafigure[1]{fyz_fig911b.pdf}} \\   
        \subcaptionbox{\label{fyz:fig911c}}{\luafigure[1]{fyz_fig911c.pdf}} \\
        \subcaptionbox{\label{fyz:fig911d}}{\luafigure[1]{fyz_fig911d.pdf}}                                             
  ...
  \section{Relativita času}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig912}
      \centering
        \subcaptionbox{Sylva  \label{fyz:fig912a}}{\luafigure[1]{fyz_fig912a.pdf}} \\    
        \subcaptionbox{Slávek \label{fyz:fig912b}}{\luafigure[1]{fyz_fig912b.pdf}}                                             
    ...
    Obr. \ref{fyz:fig912a} ukazuje podstatu experimentu, který provádí Sylva, jež se svým vybavením
    ...
    \luagraphic[1]{fyz_fig913.pdf}{Lorentzův faktor \(\gamma\) jako funkce rychlostního parametru 
    \(\beta = v/c\). (\cite[s.~1013]{Halliday2001})}{fyz:fig913}
  ...
  \section{Princip relativity}\label{fyz:IchapXVsecIII}     
    ...
    \luagraphic[0.8]{fyz_fig005.pdf}{Dvě souřadnicové soustavy v rovnoměrném relativním pohybu podél
    svých x-ových os. (\cite[s.~211]{Feynman01})}{fyz:fig005}
    ...
    \subsection{Problém volby vztažné soustavy}
      ...
      \luagraphic[1]{fyz_fig905.png}{Každý pohyb je relativní vzhledem k pozorovateli. 
      (\cite[s.~24]{Beiser1975})}{fyz:fig905}
  ...
  \section{Lorentzova transformace}\label{fyz:IchapXVsecIV}
    ...
    \luagraphic[1]{fyz_fig900.png}{Pohyb Země hypotetickýmm etherem. 
    (\cite[s.~20]{Beiser1975})}{fyz:fig900}
    ...
    \luagraphic[1]{fyz_fig901.png}{Michelsonův-Morleyův pokus. 
    (\cite[s.~21]{Beiser1975})}{fyz:fig901}
  ...
  \section{Michelson-Morleyův experiment}\label{fyz:IchapXVsecV}
    ...
    \luagraphic[1]{fyz_fig004.pdf}{chématický náčrt Michelsonova-Morleyova experimentu. 
    (\cite[s.~214]{Feynman01})}{fyz:fig004}
...
%---------------------------------------------------------------------------------------------------
  \section{Transformace času}\label{fyz:IchapXVsecVI}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig003}
      \centering
      \subcaptionbox{\label{fyz:fig003a}}{\luafigure[0.4]{fyz_fig003a.pdf}}     \hspace{1em}
      \subcaptionbox{\label{fyz:fig003b}}{\luafigure[0.2]{fyz_fig003c.pdf}}     \\
      \subcaptionbox{\label{fyz:fig003c}}{\luafigure[0.9]{fyz_fig003b.pdf}}
