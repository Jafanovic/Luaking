...
\chapter{Speciální teorie relativity}\label{fyz:IchapXV}
  \section{Co všechno patří k relativitě}\label{fyz:IchapXVsecI}
    ...
    družici Země, jež se pohybuje rychlostí \qty{9.0}{\km\per\s} je \(v/c = \num{3e-5}\) a po 
    ...
    \subsection{Trocha historie}
      ...
      \subsection{Mezní rychlost}
        ...
        \luagraphic[1]{fyz_fig0909.pdf}{Data Bertozziho experimentu ukazují úzkou shodu se speciální
          ...
          \num{4.5}, \qty{15}{\mega\electronvolt} (nebo \num{1}, \num{2}, \num{3}, \num{9}, \num{30}
          v \(mc^2\)). Rychlost: \num{0.752}, \num{0.828}, \num{0.922}, \num{0.974}, \num{1.0} v
          \(c^2\) (nebo \num{0.867}, \num{0.910}, \num{0.960}, \num{0.987}, \num{1} v \(c\)).
  ...
  \section{Měření událostí}
    ...
    Takové připsání může ovšem narazit na praktickou potíž. Dejme tomu, že například \qty{1}{\km} od
    nás napravo praskne balon a \qty{2}{\km} od nás nalevo je odpálena raketa, přičemž obojí se stane
  ...
  \section{Relativita času}
    ...
    \subsection{Dva testy dilatace času}
      ...
      hodinami (např. v laboratoři), pak jejich průměrná doba života je \qty{2 200}{\micro\second}. Je
      ...
      dobu života
      \begin{equation*}
        \Delta t = \gamma\Delta t_0=\num{28.87}\cdot\qty{2 200}{\micro\second}=\qty{63.5}{\micro\second},
      \end{equation*}
  ...
  \section{Princip relativity}\label{fyz:IchapXVsecIII}     
    ...
    rychlostí \(c = \qty{3e5}{\km\per\s}\). Dalším důsledkem těchto rovnic je, že pohybuje-li se
  ...
  \section{Lorentzova transformace}\label{fyz:IchapXVsecIV}
    ...
    \qty{3e4}{\metre\per\second}; pohybuje-li se i Slunce, je naše rychlost vůči etheru ještě větší
  ...
  \section{Michelson-Morleyův experiment}\label{fyz:IchapXVsecV}
    ...
    \qty{90}{\degree}, takže \(BC\) leží ve směru pohybu a \(BE\) je na něho kolmé. Malý rozdíl 
    ...
    Země je přibližně \qty{30}{\km\per\s} a nějaký posun vůči éteru by měl být aspoň takový v určitém
...
%---------------------------------------------------------------------------------------------------
  \section{Transformace času}\label{fyz:IchapXVsecVI}
    ...
    Jsou to částice, které se spontánně rozpadají s průměrnou dobou života \qty{2.2e-6}{\s}. Na Zemi 
    ...
    je \(\num{2.2e-6}/\sqrt{1 - 9^2/10^2} = \qty{5.047e-6}{\s}\). Naše předpověď je správná - to je 
  ...
  \section{Relativistická dynamika}\label{fyz:IchapXVsecX}
    ...
    asi \qty{0.025}{\mm}, nebo \sfrac{1}{4} tloušťky papíru! Elektrony pohybující se takovou
