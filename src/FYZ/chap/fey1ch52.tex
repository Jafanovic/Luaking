...
\chapter{Symetrie fyzikálních zákonů}\label{fyz:IchapLII}
  ...
  \section{Která ruka je pravá?}\label{fyz:IchapLIIsecVI}
    ...
    \qty{175}{\cm} vysocí.} On by nás přerušil: „Moment, co to vlastně znamená - 175 centimetrů?
  ...
  \section{Parita se nezachovává}\label{fyz:IchapLIIsecVII}
    ...
    Existují \(K^+ = us\), \(K^0 = ds/sd\) a \(K^-=su\). Mají hmotnost \qty{493.667\pm0.013}{\MeV}
    (\(K^\pm\)) a \qty{497.648\pm0.022}{\MeV} (\(K^0\)). Kredit: Wikipedia}.
