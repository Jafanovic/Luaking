...
\chapter{Symetrie fyzikálních zákonů}\label{fyz:IchapLII}
  ...
  \section{Zrcadlový obraz}\label{fyz:IchapLIIsecIV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig441}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig441.jpg}
  ...
  \section{Polární a axiální vektory}\label{fyz:IchapLIIsecV}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig442}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig442.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig443}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig443.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig444}
      \centering
      \includegraphics[width=1\linewidth]{fyz_fig444.pdf}
  ...
  \section{Která ruka je pravá?}\label{fyz:IchapLIIsecVI}
    ...
    Chtěli bychom mu o nás všechno povědět. Samozřejmě bychom začali s deﬁnováním čísel, a to tak,
  ...
  \section{Parita se nezachovává}\label{fyz:IchapLIIsecVII}
    ...
    \begin{figure}[ht!]      %\ref{fyz:fig445}
      \centering
      \subcaptionbox{\label{fyz:fig445a}}{\luafigure[0.48]{fyz_fig445a.pdf}}
      \subcaptionbox{\label{fyz:fig445b}}{\luafigure[0.48]{fyz_fig445b.pdf}}
