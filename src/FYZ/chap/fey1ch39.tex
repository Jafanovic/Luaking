...
\chapter{Kinetická teorie plynů}\label{fyz:IchapIXL}  
  ...
  \section{Tlak plynu}\label{fyz:IchapIXLsecII}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0242}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0242.pdf}
    ...
    plynu na určitý objem? je to možno snadno určit, neboť tlak představuje \sfrac{2}{3} z energie
    ...
    kdy před \(U\) nebudou \sfrac{2}{3}, ale nějaké jiné číslo. Označení \((γ−1)\) zvolíme proto,
    protože už téměř sto let používají takové označení fyzici. V našem případě, pro jednoatomový
    plyn, jako například hélium, je \(y\) rovno \sfrac{5}{3}, protože tehdy platí \((γ−1) =
    \sfrac{2}{3}\).
    ...
    vzrůstá, je součin tlaku a \sfrac{5}{3} mocniny objemu pro jednoatomový plyn konstantní. Ačkoli
  ...
  \section{Stlačitelnost záření}\label{fyz:IchapIXLsecIII}
    ...
    počtem fotonů. Dostaneme tak \sfrac{1}{3} vnitřní energie plynu
    \begin{equation}\label{fyz:eq627}
      pV=\frac{U}{3}\qquad \text{(fotonového plynu)}.
    \end{equation} 
    Stojí-li před \(U\) faktor \sfrac{1}{3}, bude v případě fotonů \((γ−1)\) ze vztahu
    (\ref{fyz:eq622}) rovno \sfrac{1}{3}, takže \(γ=\sfrac{4}{3}\), a proto musí záření v nádobě
    vyhovovat vztahu
  ...
  \section{Teplota a kinetická energie}\label{fyz:IchapIXLsecIV}
    ...
    vzájemné interakci.
    \begin{figure}[ht!] %\ref{fyz:fig0243}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0243.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0244}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig0244.pdf}
    ...
    \begin{figure}[ht!] %\ref{fyz:fig0245}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig0245.pdf}
    ...
    molekuly rovna \(\frac{3}{2}kT\). (Koeﬁcient \sfrac{3}{2} jsme zavedli jen z praktických důvodů,
