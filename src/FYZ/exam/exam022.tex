\begin{fyzexam}{Elementární částice nazvaná kladný kaon (\(K^+\)) má v klidu průměrnou dobu života
  \qty{0.1237}{\micro\s}, tj. jedná se o dobu života měřenou v klidové soustavě kaonu.
  Vytvářejí-li se v atmosféře kladné kaony s rychlostí \num{0.990}c vzhledem k zemské vztažné
  soustavě, jak daleko se v této soustavě během své doby života dostanou?
  ...
  neužívali speciální relativity, doba letu by činila \qty{0.1237}{\micro\s}, což je doba života
  částice, a tudíž uražená vzdálenost by byla
  \begin{align*}
    d &= v\Delta t_k                                                        \\
      &= \num{0.990}\cdot\qty{3.00e8}{\m\per\s}\cdot\qty{1.237e-7}{\s}        \\
      &= \qty{36.7}{\m}  \qquad\text{(chybná odpověď)} 
  \end{align*}  
  ...
  znalosti vlastní doby života kaonu \(t_0 = \qty{0.1237}{\s}\) měřené v jeho klidové soustavě
  \begin{align*}
    \Delta t &= \dfrac{\Delta t_0}{\sqrt{1  - \left(\dfrac{v}{c}\right)^2}}   \\
              &= \dfrac{\qty{0.123 7e-6}{\s}}{\sqrt{1  - (\num{0.990}c/c)^2}}  \\
              &= \qty{8.769e-7}{\s}
  \end{align*}
  ...
  \begin{align*}
    d &= v\Delta t_k                                                      
      = \num{0.990}\cdot\qty{3.00e8}{\m\per\s}\cdot\qty{8.769e-7}{\s}        \\
      &= \qty{260}{\m}  
  \end{align*} 
