...
\begin{mdframed}[style=mdexam]
  \begin{example}\label{FYZ:exam029}
    ...
    \qty{3}{\kg} z \qty{10}{\degreeCelsius} na \qty{100}{\degreeCelsius}. Účinnost vařiče
    \qty{34}{\percent}, výhřevnost petroleje je \qty{44}{\mega\joule\per\kg} a měrná kapacita vody
    \qty{4180}{\joule\per\kg\per\kelvin}. (\cite[s.~31]{Bartuska1997})}
    ...
    Čísleně 
    \begin{align*}
       m_1 &= \dfrac{\qty{3}{\kg}\cdot\qty{4180}{\joule\per\kg\per\kelvin}\cdot\qty{90}{\kelvin}}
                    {\num{0.34}\cdot\qty{44}{\mega\joule\per\kg}}                                  \\
       m_1 &= \dfrac{3\cdot4180\cdot90}{\num{0.34}\cdot\num{44e6}}\cdot
              \dfrac{\unit{\kg}\cdot\unit{\joule\per\kg\per\kelvin}\cdot\unit{\kelvin}}
                    {\unit{\J\per\kg}}                                                              \\
       m_1 &\approx \qty{75}{\g}    
     \end{align*}
     Na zahřátí vody o hmotnosti \qty{3}{\kg} z \qty{10}{\degreeCelsius} na \qty{100}{\degreeCelsius}
     na petrolejovém vařiči je zapotřebí \qty{75}{\g} petroleje.
  \end{example} 
\end{mdframed}