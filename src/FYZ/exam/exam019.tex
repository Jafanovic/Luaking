\begin{fyzexam}{Lze ukázat, že elektron s kinetickou energií \qty{20}{\giga\electronvolt}
  (mluvívá se o \qty{20}{\giga\electronvolt}-elektronu) má rychlost \(v = \num{0.999 999 999
  ...
  \qty{4.0e16}{\meter}), s jakým časovým náskokem světelný pulz zvítězí?
  ...
  \begin{align*}
    \Delta t &=\dfrac{L}{c}\cdot\left(1-\dfrac{v}{c}\right)                                      \\
             &=\dfrac{\qty{4.0e16}{\meter}}{\qty{3.0e8}{\meter\per\s}}(1-\num{0.999 999 999 67}) \\
             &=\qty{0.044}{\s} = \qty{44}{\milli\s}.
  \end{align*} 
\end{fyzexam}