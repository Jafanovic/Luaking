...
\section{Třídění}
  ...
  \begin{center}
    \includegraphics[width=0.65\linewidth]{zzt_fig004.pdf}
  \end{cener}
  ...
  \begin{center}
    \includegraphics[width=0.45\linewidth]{zzt_fig005.pdf}
  \end{center}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{zzt_fig006.pdf}
  \end{center}
  ...
  \begin{center}
    \includegraphics[width=0.5\linewidth]{zzt_fig009.pdf}
  \end{center}
  
  Zařízení přejezdová se dělí podle způsobu výstrahy na přejezdová zařízení:
  \begin{center}
    \includegraphics[width=0.65\linewidth]{zzt_fig010.pdf}
  \end{center}
  ...
  \begin{figure}[ht!] %\ref{zzt:fig003}
    \centering
    \includegraphics[width=0.5\linewidth]{zzt_fig003.pdf}
    \caption{Stanice
