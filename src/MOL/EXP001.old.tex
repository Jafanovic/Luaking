...
\newpage
  \section{Zadání}
    ...
    \qty{468}{\MHz} mezi řídicím systémem (embedded PC) a senzory na vzdálenost minimálně 2000 m 
    ve volném terénu.
...
%   host processing. 
  ...
  \section{RX LNA Matching}
    ...
    \subsection{Three-Element Match Network}
      ...
      The RXp and RXn inputs of the Si446x/Si4362 RX LNA internally contain high value (~\qty{15}{k\ohm}) 
