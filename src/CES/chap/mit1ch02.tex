...
\chapter{Mikroprocesorová technika}\label{ces:IchapIV}
  ...
  \twocolumn[\section{Základní funkce a části počítače}\label{ces:IchapIVsecI}]
    ...
    \luagraphic[0.6]{ces_fig009.jpg}{První komerčně dostupný 4b procesor \texttt{4004} s frekvencí
      \qty{108}{\kHz} od firmy Intel. Obsahoval \num{2300} tranzistorů a jeho výkon odpovídal 0.06
      MIPS (dále obsahoval 16 4bitových registrů, \num{45} jedno a dvou bitových instrukcí. čtyř
  ...
  \section{Procesor}\label{ces:IchapIVsecII}
    ...
    \begin{itemize}[noitemsep]
      ...
      \item \hyperlink{ces:IchapIVsecIIssecI}{mikroprogramovaného řadiče} - jehož nedílnou součástí
            je řídicí paměť obsahující mikroinstrukce, přičemž každá ze strojových instrukcí je
    ...
    \subsection{Mikroprogramový řadič}\label{ces:IchapIVsecIIssecI}\hypertarget{ces:IchapIVsecIIssecI}
  ...
  \section{Paměť}\label{ces:IchapIVsecV}
    ...
    \subsection{Programování paměti \texttt{FLASH} v systému}
      ...
      \begin{enumerate}[noitemsep]
        ...
        \item Odpočítat čas na mazání (\qty{10}{\milli\second}).
        \item Zapsat příkaz \emph{„erase-verify"}.
        \item Odpočítat čas na prodlevu (\qty{6}{\micro\second}).
      ...
      \begin{enumerate}[noitemsep]
        ...
        \item Odpočítat čas na programování na této adrese (\qty{10}{\milli\second}).
