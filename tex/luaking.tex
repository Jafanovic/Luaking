...
% --- Loading Fonts ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\usepackage{pifont}                          % Using Dingbats font in xelatex
% --- Koma script ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% ---- Table fo content ----------------
% http://mirror.hmc.edu/ctan/macros/latex/contrib/koma-script/doc/scrguien.pdf
\setuptoc{toc}{leveldown}
\DeclareTOCStyleEntry[numwidth=3em, indent=1em]{tocline}{part} % scrguien page 357
...
\usepackage{mdframed}                      % auto-split frame environment
% ~~~~~~~~ Table of contents ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\usepackage[inline]{enumitem}                 % provides extensions  LaTeX's list environments 
...
% when inserted pages does not match the print space. 
  \usepackage{pdfpages}     % \includepdf >> Inserts pages of an external PDF document.
...
\begin{center}
  \hfill\includegraphics[width=\linewidth]{luaking_title.jpg}\par
  \vspace{4\baselineskip}
  {\Huge 
  \textbf{LUAKING}\\ Školní zápisník\par}
  \vspace{4\baselineskip}
  by\par
