...
% \usepackage{lua-visual-debug}   % This package aids debugging TEX document
\usepackage{scalerel}
\usepackage{relsize}    % https://tex.stackexchange.com/questions/39181/big-integral-sign

% https://tex.stackexchange.com/questions/102173/using-allowdisplaybreaks-locally-for-a-single-chapter-single-equation
\allowdisplaybreaks
